...
$appConfig->getApplication()->setBaseLanguageDirectory(dirname(dirname(__DIR__)) . "/magic-admin/inc.lang");
...
$appLanguage = new AppLanguage(
    ...
    function($var, $value)
    {
        $inputSource = dirname(dirname(__DIR__)) . "/magic-admin/inc.lang/source/app.ini";
