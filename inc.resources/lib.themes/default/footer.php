...
?>
    ...
    <script>
        ...
        const notifications = <?php echo AppFeed::getNotifications($databaseBuilder, $currentUser, 5); ?>;

        // Message data from the server in JSON format
        const messages = <?php echo AppFeed::getMessages($databaseBuilder, $currentUser, 5); ?>;
