...
class ERDGenerator {
    ...
    createTable(entity, index, x, y) {
        ...
        headerRect.setAttribute("height", 27);
        headerRect.setAttribute("fill", "#DDDDDD");
        ...
        editIcon.setAttribute("y", 19);
        editIcon.setAttribute("font-size", "12");
        ...
        entity.columns.forEach((col, index) => {
            ...
            columnText.setAttribute("fill", "#505050"); // Set type text color
            ...
            typeText.setAttribute("fill", "#505050"); // Set type text color
            typeText.textContent = col.type; // Display the column type
            typeText.setAttribute("text-anchor", "end"); // Align the text to the right
            group.appendChild(typeText);

            // Add a top border starting from the second column (index > 0)
            //if (index > 0) 
            {
                ...
                borderLine.setAttribute("stroke", "#666666"); // Set the border color
...
let erdGenerator = new ERDGenerator(document.getElementById("erd-svg"));
