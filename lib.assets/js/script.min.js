let initielized=!1,currentEntity="",currentModule="",currentEntity2Translated="",lastErrorLine=-1,keyWords="absolute,action,add,after,aggregate,alias,all,allocate,alter,analyse,analyze,and,any,are,array,as,asc,assertion,at,authorization,avg,before,begin,between,binary,bit,bit_length,blob,boolean,both,breadth,by,call,cascade,cascaded,case,cast,catalog,char,character,character_length,char_length,check,class,clob,close,coalesce,collate,collation,column,commit,completion,connect,connection,constraint,constraints,constructor,continue,convert,corresponding,count,create,cross,cube,current,current_date,current_path,current_role,current_time,current_timestamp,current_user,cursor,cycle,data,date,day,deallocate,dec,decimal,declare,default,deferrable,deferred,delete,depth,deref,desc,describe,descriptor,destroy,destructor,deterministic,diagnostics,dictionary,disconnect,distinct,do,domain,double,drop,dynamic,each,else,end,end-exec,equals,escape,every,except,exception,exec,execute,exists,external,extract,false,fetch,first,float,for,foreign,found,free,from,full,function,general,get,global,go,goto,grant,group,grouping,having,host,hour,identity,ignore,immediate,in,indicator,initialize,initially,inner,inout,input,insensitive,insert,int,integer,intersect,interval,into,is,isolation,iterate,join,key,language,large,last,lateral,leading,left,less,level,like,limit,local,localtime,localtimestamp,locator,lower,map,match,max,min,minute,modifies,modify,month,names,national,natural,nchar,nclob,new,next,no,none,not,null,nullif,numeric,object,octet_length,of,off,offset,old,on,only,open,operation,option,or,order,ordinality,out,outer,output,overlaps,pad,parameter,parameters,partial,path,placing,position,postfix,precision,prefix,preorder,prepare,preserve,primary,prior,privileges,procedure,public,read,reads,real,recursive,ref,references,referencing,relative,restrict,result,return,returns,revoke,right,role,rollback,rollup,routine,row,rows,savepoint,schema,scope,scroll,search,second,section,select,sequence,session,session_user,set,sets,size,smallint,some,space,specific,specifictype,sql,sqlcode,sqlerror,sqlexception,sqlstate,sqlwarning,start,state,statement,static,structure,substring,sum,system_user,table,temporary,terminate,than,then,time,timestamp,timezone_hour,timezone_minute,to,trailing,transaction,translate,translation,treat,trigger,trim,true,under,union,unique,unknown,unnest,update,upper,usage,user,using,value,values,varchar,variable,varying,view,when,whenever,where,with,without,work,write,year,zone";function initTooltip(){$(document).on("mouseenter",'[name="erd-map"] area, [data-toggle="tooltip"]',function(e){let t=$(this).attr("data-title")||$(this).attr("title"),a=$('<div class="tooltip"></div>').html(t);$("body").append(a),a.addClass("visible"),$(document).on("mousemove",function(e){let t=a.outerWidth(),n=a.outerHeight(),i=e.pageX+15,l=e.pageY+15;i+t>$(window).width()&&(i=e.pageX-t-15),l+n>$(window).height()&&(l=e.pageY-n-15),a.css({left:i,top:l})})}),$(document).on("mouseleave",'[name="erd-map"] area, [data-toggle="tooltip"]',function(e){$(".tooltip").remove(),$(document).off("mousemove")})}function showModal(e,t,a,n){return new Promise((i,l)=>{let o=$("#customAlert"),r=$("#alertOverlay"),d=$("#alertMessage"),c=$("#alertTitle"),s=$("#modalFooter");s.empty(),r.show(),o.modal("show"),d.html(e),c.html(t),a.forEach(e=>{let t=$("<button>").addClass(`btn ${e.class||"btn-secondary"}`).text(e.caption).on("click",()=>{o.modal("hide"),r.hide(),e.fn(),i(e.caption)});s.append(t)}),o.on("hidden.bs.modal",()=>{n&&n()})})}async function asyncAlert(e,t,a){let n=await showModal(e,t,a,function(){$("#alertOverlay").css({display:"none"}),$(".modal").css({overflow:"","overflow-y":"auto"})});console.log(n)}String.prototype.equalIgnoreCase=function(e){return this.toLowerCase()==e.toLowerCase()},String.prototype.replaceAll=function(e,t,a){return this.replace(RegExp(e.replace(/([\/\,\!\\\^\$\{\}\[\]\(\)\.\*\+\?\|\<\>\-\&])/g,"\\$&"),a?"gi":"g"),"string"==typeof t?t.replace(/\$/g,"$$$$"):t)},String.prototype.replaceAll=function(e,t,a){return this.replace(RegExp(e.replace(/([\/\,\!\\\^\$\{\}\[\]\(\)\.\*\+\?\|\<\>\-\&])/g,"\\$&"),a?"gi":"g"),"string"==typeof t?t.replace(/\$/g,"$$$$"):t)},String.prototype.capitalize=function(){return this.replace(/\w\S*/g,function(e){return e.charAt(0).toUpperCase()+e.substring(1).toLowerCase()})},String.prototype.prettify=function(){let e,t,a=this.split(" ");for(e=0;e<a.length;e++)switch(t=a[e]){case"Id":a[e]="";break;case"Ip":a[e]="IP"}return a.join(" ")},String.prototype.replaceAll=function(e,t){return this.replace(RegExp(e,"g"),t)},jQuery(function(){$(document).on("change",".multiple-selection",function(e){let t=$(this).val();$(".multiple-selection").val(t)}),$(document).on("click","#vscode",function(){let e=$("#current_application option:selected").attr("data-directory");window.location="vscode://file/"+e}),$(document).on("click","#load_table",function(e){e.preventDefault(),loadTable()}),$(document).on("click","#load_column",function(e){e.preventDefault();let t=$('[name="source_table"]').val(),a=$("table.main-table tbody");loadColumn(t,a)}),$(document).on("change",'select[name="source_table"]',function(e){let t=$(this).val(),a=$(this).find("option:selected").attr("data-primary-key")||"";updateTableName(t+".php",t,t,t,a)}),$(document).on("click",".button-save-application-config",function(e){e.preventDefault();let t=$(this).closest(".modal").find("form"),a=t.serializeArray(),n={name:t.find('[name="application_name"]').val(),architecture:t.find('[name="application_architecture"]').val(),description:t.find('[name="description"]').val(),database:{},sessions:{},entity_info:{},module_location:[]};for(let i in t.find(".path-manager tbody tr").each(function(e){let t=$(this).find('[name^="name"]'),a=$(this).find('[name^="path"]'),i=$(this).find('[name^="checked"]');n.module_location.push({name:t.val(),path:a.val(),active:i[0].checked})}),a){let l=a[i].name;-1!==l.indexOf("database_")&&(n.database[l.substring(9)]=a[i].value),-1!==l.indexOf("sessions_")&&(n.sessions[l.substring(9)]=a[i].value),-1!==l.indexOf("entity_info_")&&(n.entity_info[l.substring(12)]=a[i].value)}n.application_id=t.find('[name="application_id"]').val(),updateCurrentApplivation(n),$("#modal-application-setting").modal("hide")}),$(document).on("click","#generate_script",function(e){e.preventDefault(),generateScript($(".main-table tbody"))}),$(document).on("click","#switch_application",function(e){e.preventDefault(),switchApplication($("#current_application").val())}),$(document).on("change",".input-field-filter",function(e){let t=$(this)[0].checked,a=$(this).attr("value");t?($(this).closest("tr").find('.input-field-filter[value!="'+a+'"]')[0].checked=!1,prepareReferenceFilter(a,$(this))):$(this).closest("tr").find(".reference_button_filter").css("display","none")}),$(document).on("change",".input-element-type",function(e){let t=$(this).attr("value");prepareReferenceData(t,$(this))}),$(document).on("click",".reference_button_data",function(e){e.preventDefault(),$("#modal-create-reference-data").find(".modal-title").text("Create Data Reference"),$("#modal-create-reference-data").attr("data-reference-type","data");let t=$(this).closest("tr").attr("data-field-name"),a=$(this).siblings("input").attr("name");$("#modal-create-reference-data").attr("data-input-name",a),$("#modal-create-reference-data").attr("data-field-name",t),$("#modal-create-reference-data").find(".modal-body").empty(),$("#modal-create-reference-data").find(".modal-body").append(getReferenceResource());let n=$('[name="'+a+'"]').val();if(n.length<60&&loadReference(t,a,function(e){null!=e&&deserializeForm(e)}),n.length>20){let i=parseJsonData(n);"object"!=typeof i&&(i={}),deserializeForm(i)}$("#modal-create-reference-data").modal("show")}),$(document).on("click",".reference_button_filter",function(e){e.preventDefault(),$("#modal-create-reference-data").find(".modal-title").text("Create Filter Reference"),$("#modal-create-reference-data").attr("data-reference-type","filter");let t=$(this).closest("tr").attr("data-field-name"),a=$(this).siblings("input").attr("name");$("#modal-create-reference-data").attr("data-input-name",a),$("#modal-create-reference-data").attr("data-field-name",t),$("#modal-create-reference-data").find(".modal-body").empty(),$("#modal-create-reference-data").find(".modal-body").append(getReferenceResource());let n=$('[name="'+a+'"]').val().trim();if(n.length<60&&loadReference(t,a,function(e){null!=e&&deserializeForm(e)}),n.length>20){let i=parseJsonData(n);"object"!=typeof i&&(i={}),deserializeForm(i)}$("#modal-create-reference-data").modal("show")}),$(document).on("click","#apply_reference",function(e){let t=$("#modal-create-reference-data").attr("data-input-name"),a=JSON.stringify(serializeForm());$('[name="'+t+'"]').val(a),$("#modal-create-reference-data").modal("hide")}),$(document).on("click","#save_to_cache",function(e){let t=$("#modal-create-reference-data").attr("data-field-name"),a=$("#modal-create-reference-data").attr("data-input-name"),n=JSON.stringify(serializeForm());saveReference(t,a,n)}),$(document).on("click","#load_from_cache",function(e){let t=$("#modal-create-reference-data").attr("data-field-name"),a=$("#modal-create-reference-data").attr("data-input-name");loadReference(t,a,function(e){null!=e&&deserializeForm(e)})}),$(document).on("click",".reference_type",function(e){let t=$(this).val();selectReferenceType({type:t})}),$(document).on("click",".btn-add-column",function(e){let t=$(this).closest("table");addColumn(t)}),$(document).on("click",".btn-remove-last-column",function(e){let t=$(this).closest("table");removeLastColumn(t)}),$(document).on("click",".btn-add-row",function(e){let t=$(this).closest("table");addRow(t)}),$(document).on("click",".btn-remove-row",function(e){let t=$(this).closest("tbody").find("tr").length;if(t>1){let a=$(this).closest("tr");asyncAlert("Do you want to remove this row?","Delete Confirmation",[{caption:"Yes",fn(){a.remove()},class:"btn-primary"},{caption:"No",fn(){},class:"btn-secondary"}])}else 1==t&&"true"==$(this).closest("table").attr("data-empty-on-remove")&&$(this).closest("tr").find(":input").each(function(e){$(this).val("")})}),$(document).on("change",'.map-section input[type="checkbox"]',function(e){$(this)[0].checked&&$(this).closest("tr").siblings().each(function(){$(this).find('input[type="checkbox"]')[0].checked=!1})}),$(document).on("change",".entity-container-query .entity-checkbox",function(e){let t=getEntitySelection(),a=$(".entity-merge")[0].checked;getEntityQuery(t,a)}),$(document).on("change",".entity-merge",function(e){let t=getEntitySelection(),a=$(".entity-merge")[0].checked;getEntityQuery(t,a)}),$(document).on("change","#entity-check-controll",function(e){let t=$(this)[0].checked;$(".entity-checkbox-query").each(function(){$(this)[0].checked=t});let a=getEntitySelection(),n=$(".entity-merge")[0].checked;getEntityQuery(a,n)}),$(document).on("click","#create_new_app",function(e){e.preventDefault();let t=$(this).closest(".modal"),a=t.find('[name="application_name"]').val().trim(),n=t.find('[name="application_architecture"]').val().trim(),i=t.find('[name="application_description"]').val().trim(),l=t.find('[name="application_id"]').val().trim(),o=t.find('[name="application_directory"]').val().trim(),r=t.find('[name="application_namespace"]').val().trim(),d=t.find('[name="application_author"]').val().trim(),c=t.find('[name="magic_app_version"]').val().trim(),s=[];$("#modal-create-application table.path-manager tbody tr").each(function(){let e=$(this),t=e.find('td:nth-child(1) input[type="text"]').val(),a=e.find('td:nth-child(2) input[type="text"]').val(),n=e.find('td:nth-child(3) input[type="checkbox"]')[0].checked;s.push({name:t,path:a,active:n})}),""!=a&&""!=l&&""!=o&&""!=d&&$.ajax({method:"POST",url:"lib.ajax/application-create.php",dataType:"html",data:{id:l,name:a,architecture:n,description:i,directory:o,namespace:r,author:d,paths:s,magic_app_version:c},success:function(e){reloadApplicationList()},error:function(e,t){}}),$(t).modal("hide")}),$("#modal-update-path").on("show.bs.modal",function(){$.ajax({method:"POST",url:"lib.ajax/application-path.php",data:{action:"get"},success:function(e){for(;$("#modal-update-path table.path-manager > tbody > tr").length>1;)$("#modal-update-path table.path-manager > tbody > tr:last").remove();for(let t in e){if(t>0){let a=$("#modal-update-path table.path-manager > tbody > tr:first").clone();$("#modal-update-path table.path-manager > tbody").append(a)}let n=$("#modal-update-path table.path-manager > tbody > tr:nth-child("+(parseInt(t)+1)+")");n.find('input[type="text"].location-path').val(e[t].path),n.find('input[type="text"].location-name').val(e[t].name),n.find('input[type="checkbox"]')[0].checked=e[t].active}fixPathForm()}})}),$(document).on("click","#update_module_path",function(e){e.preventDefault();let t=[];$("#modal-update-path table.path-manager tbody tr").each(function(){let e=$(this),a=e.find('td:nth-child(1) input[type="text"]').val(),n=e.find('td:nth-child(2) input[type="text"]').val(),i=e.find('td:nth-child(3) input[type="checkbox"]')[0].checked;t.push({name:a,path:n,active:i})});let a=$("#current_module_location");t.length>0&&$.ajax({method:"POST",url:"lib.ajax/application-path.php",data:{action:"update",paths:t},success:function(e){for(let t in a.empty(),e)a[0].options[a[0].options.length]=new Option(e[t].name+" - "+e[t].path,e[t].path),e[t].active&&a.val(e[t].path);for(;$("#modal-update-path table.path-manager tbody tr").length>1;)$("#modal-update-path table.path-manager tbody tr:last-child").remove();$('#modal-update-path table.path-manager tbody tr input[type="text"]').val("")}}),$("#modal-update-path").modal("hide")}),$(document).on("click","#update_current_location",function(e){e.preventDefault();let t=$("#current_module_location");$.ajax({method:"POST",url:"lib.ajax/application-path.php",data:{action:"default",selected_path:t.val()},success:function(e){for(let a in t.empty(),e)t[0].options[t[0].options.length]=new Option(e[a].name+" - "+e[a].path,e[a].path),e[a].active&&t.val(e[a].path)}})}),$(document).on("click",".entity-container-file .entity-li a",function(e){e.preventDefault();let t=$(this).attr("data-entity-name"),a=$(this);getEntityFile([t],function(){$(".entity-container-file .entity-li").removeClass("selected-file"),a.closest("li").addClass("selected-file")})}),$(document).on("click",".module-list-file .file-li a",function(e){e.preventDefault();let t=$(this).attr("data-file-name"),a=$(this);getModuleFile(t,function(){$(".file-li").removeClass("selected-file"),a.parent().addClass("selected-file")})}),$(document).on("click",".entity-container-query .entity-li a",function(e){e.preventDefault();let t=$(this).attr("data-entity-name");getEntityQuery([t])}),$(document).on("click","#button_save_module_file",function(e){e.preventDefault(),saveModule()}),$(document).on("click","#button_save_entity_file",function(e){e.preventDefault(),saveEntity()}),$(document).on("click","#button_save_entity_query",function(e){e.preventDefault(),saveQuery()}),$("tbody.data-table-manual-sort").each(function(e){let t=$(this)[0];Sortable.create(t,{animation:150,scroll:!0,handle:".data-sort-handler",onEnd:function(){}})}),$(document).on("click",".generate_entity",function(){let e=$(".rd-entity-name").val(),t=$(".rd-table-name").val();asyncAlert("Are you sure you want to generate entity and replace existing file?","Confirmation",[{caption:"Yes",fn(){$.ajax({method:"POST",url:"lib.ajax/entity-generator.php",data:{entityName:e,tableName:t},success:function(e){updateEntityFile(),updateEntityQuery(!0),updateEntityRelationshipDiagram()}})},class:"btn-primary"},{caption:"No",fn(){},class:"btn-secondary"}])}),$(document).on("change",".map-key",function(e){onChangeMapKey($(this))}),$(document).on("keyup",".map-key",function(e){onChangeMapKey($(this))}),$(document).on("change","#export_to_excel",function(e){$(this)[0].checked&&($("#export_to_csv")[0].checked=!1,$("#export_use_temporary")[0].disabled=!0)}),$(document).on("change","#export_to_csv",function(e){$(this)[0].checked?($("#export_to_excel")[0].checked=!1,$("#export_use_temporary")[0].disabled=!1):$("#export_use_temporary")[0].disabled=!0}),$(document).on("change",".entity-container-relationship .entity-checkbox",function(e){loadDiagramMultiple()}),$(document).on("click",".reload-diagram",function(e){loadDiagramMultiple()}),$(document).on("click",".entity-container-relationship .entity-li a",function(e){e.preventDefault();let t=[];(t=addDiagramOption(t)).push("entity[]="+$(this).attr("data-entity-name")),t.push("rnd="+new Date().getTime());let a=$("<img />");a.attr("src","lib.ajax/entity-relationship-diagram.php?"+t.join("&")),$(".erd-image").empty().append(a)}),$(document).on("click",".btn-move-up",function(){let e=$(this).closest("tr");e.prev().length&&e.insertBefore(e.prev())}),$(document).on("click",".btn-move-down",function(){let e=$(this).closest("tr");e.next().length&&e.insertAfter(e.next())}),$(document).on("click","table.path-manager .path-remover",function(){if($(this).closest("tbody").find("tr").length>1){let e=$(this).closest("tr");asyncAlert("Deleting this path will not remove the directory or its files. <br>Do you want to delete this path?","Delete Confirmation",[{caption:"Yes",fn(){e.remove()},class:"btn-primary"},{caption:"No",fn(){},class:"btn-secondary"}])}fixPathForm()}),$(document).on("click","table.path-manager .add-path",function(){let e=$(this).closest("table").find("tbody tr:first").clone();e.find('input[type="text"]').val(""),e.find('input[type="checkbox"]').removeAttr("checked"),$(this).closest("table").find("tbody").append(e),fixPathForm()}),$(document).on("click",".create-new-application",function(){let e=$("#modal-create-application #create_new_app");e[0].disabled=!0,$('[name="application_name"]').val(""),$('[name="application_id"]').val(""),$('[name="application_directory"]').val(""),$('[name="application_namespace"]').val(""),$('[name="application_author"]').val(""),$('[name="magic_app_version"]').empty(),$.ajax({type:"GET",url:"lib.ajax/application-new.php",success:function(t){for(let a in $('[name="application_name"]').val(t.application_name),$('[name="application_id"]').val(t.application_id),$('[name="application_architecture"]').val(t.application_architecture),$('[name="application_directory"]').val(t.application_directory),$('[name="application_namespace"]').val(t.application_namespace),$('[name="application_author"]').val(t.application_author),$('[name="application_description"]').val(t.application_description),t.magic_app_versions){let n=t.magic_app_versions[a].latest;$('[name="magic_app_version"]')[0].appendChild(new Option(t.magic_app_versions[a].value,t.magic_app_versions[a].key,n,n))}reloadApplicationList(),e[0].disabled=!1}})}),$(document).on("click",".container-translate-entity .entity-list .entity-li a",function(e){e.preventDefault(),e.stopPropagation();let t=$(this);currentEntity2Translated=$(this).attr("data-entity-name"),translateEntity(function(){$(".container-translate-entity .entity-list .entity-li").removeClass("selected-file"),t.closest("li").addClass("selected-file")})}),$(document).on("click","#button-save-entity-translation",function(){let e=transEd2.getDoc().getValue(),t=$(".entity-name").val(),a=$(".entity-property-name").val(),n=$(".target-language").val();$.ajax({method:"POST",url:"lib.ajax/entity-translate.php",dataType:"json",data:{userAction:"set",entityName:t,translated:e,propertyNames:a,targetLanguage:n},success:function(e){}})}),$(document).on("click","#button-save-module-translation",function(){let e=transEd4.getDoc().getValue(),t=$(".module-property-name").val(),a=$(".target-language").val();$.ajax({method:"POST",url:"lib.ajax/module-translate.php",dataType:"json",data:{userAction:"set",translated:e,propertyNames:t,targetLanguage:a},success:function(e){}})}),$(document).on("change",".target-language",function(){let e=$(this).val(),t=$(this).attr("data-translate-for");$(".target-language").val(e),reloadTranslate(t)}),$(document).on("change",".filter-translate",function(){let e=$(this).val(),t=$(this).attr("data-translate-for");$(".filter-translate").val(e),reloadTranslate(t)}),$(document).on("change",".select-module",function(){let e=$(this)[0].checked;$(this).closest(".module-group").find("ul li").each(function(t){$(this).find('input[type="checkbox"]')[0].checked=e}),translateModule()}),$(document).on("change",".module-for-translate",function(){translateModule()}),$(document).on("click","table.language-manager .add-language",function(){let e=$(this).closest("table").find("tbody tr:first").clone();e.find('input[type="text"]').val(""),e.find('input[type="checkbox"]').removeAttr("checked"),$(this).closest("table").find("tbody").append(e),fixLanguageForm()}),$(document).on("click","table.language-manager .language-remover",function(){if($(this).closest("tbody").find("tr").length>1){let e=$(this).closest("tr");asyncAlert("Deleting this language will not remove the directory or its files. <br>Do you want to delete this language?","Delete Confirmation",[{caption:"Yes",fn(){e.remove()},class:"btn-primary"},{caption:"No",fn(){},class:"btn-secondary"}])}fixLanguageForm()}),$("#modal-update-language").on("show.bs.modal",function(){$.ajax({method:"POST",url:"lib.ajax/application-language.php",data:{action:"get"},success:function(e){for(;$("#modal-update-language table.language-manager > tbody > tr").length>1;)$("#modal-update-language table.language-manager > tbody > tr:last").remove();for(let t in e){if(t>0){let a=$("#modal-update-language table.language-manager > tbody > tr:first").clone();$("#modal-update-language table.language-manager > tbody").append(a)}let n=$("#modal-update-language table.language-manager > tbody > tr:nth-child("+(parseInt(t)+1)+")");n.find('input[type="text"].language-name').val(e[t].name),n.find('input[type="text"].language-code').val(e[t].code),n.find('input[type="checkbox"]')[0].checked=e[t].active}fixLanguageForm()}})}),$(document).on("click","#update-application-language",function(e){e.preventDefault();let t=[];$("#modal-update-language table.language-manager tbody tr").each(function(){let e=$(this),a=e.find('td:nth-child(1) input[type="text"]').val(),n=e.find('td:nth-child(2) input[type="text"]').val(),i=e.find('td:nth-child(3) input[type="checkbox"]')[0].checked;t.push({name:a,code:n,active:i})});let a=$(".target-language");t.length>0&&$.ajax({method:"POST",url:"lib.ajax/application-language.php",data:{action:"update",languages:t},success:function(e){for(let t in a.empty(),e)for(let n=0;n<a.length;n++)a[n].options[a[n].options.length]=new Option(e[t].name+" - "+e[t].code,e[t].code),e[t].active&&a.val(e[t].code);for(;$("#modal-update-language table.language-manager tbody tr").length>1;)$("#modal-update-language table.language-manager tbody tr:last-child").remove();$('#modal-update-language table.language-manager tbody tr input[type="text"]').val("")}}),$("#modal-update-language").modal("hide")}),$(document).on("click",".button-execute-query",function(e){e.preventDefault();let t=$(this).closest(".modal");asyncAlert("Do you want to execute the queries on the current database?","Confirmation",[{caption:"Yes",fn(){let e=t.find("textarea").val();$.ajax({method:"POST",url:"lib.ajax/query-execute.php",data:{action:"execute",query:e},success:function(e){let a=getEntitySelection(),n=$(".entity-merge")[0].checked;getEntityQuery(a,n),t.modal("hide")}})},class:"btn-primary"},{caption:"No",fn(){},class:"btn-secondary"}])}),$(document).on("click",".default-language",function(e){e.preventDefault();let t=$(".target-language");$.ajax({method:"POST",url:"lib.ajax/application-language.php",data:{action:"default",selected_language:t.val()},success:function(e){for(let a in t.empty(),e)for(let n=0;n<t.length;n++)t[n].options[t[n].options.length]=new Option(e[a].name+" - "+e[a].code,e[a].code),e[a].active&&t.val(e[a].code)}})}),$(document).on("click","area",function(e){e.preventDefault();let t=$(this).attr("data-type"),a={},n="",i="";if("area-relation"==t){i="lib.ajax/entity-relationship.php",n="Entity Relationship";let l=$(this).attr("data-namespace"),o=$(this).attr("data-entity"),r=$(this).attr("data-table-name"),d=$(this).attr("data-column-name"),c=$(this).attr("data-reference-namespace"),s=$(this).attr("data-reference-entity"),u=$(this).attr("data-reference-table-name"),p=$(this).attr("data-reference-column-name");a={dataType:t,namespaceName:l,entityName:o,tableName:r,columnName:d,referenceNamespaceName:c,referenceEntityName:s,referenceTableName:u,referenceColumnName:p}}else{i="lib.ajax/entity-detail.php",n="Entity Detail";let m=$(this).attr("data-namespace"),f=$(this).attr("data-entity"),h=$(this).attr("data-table-name");a={dataType:t,namespaceName:m,entityName:f,tableName:h}}$(".entity-detail").empty(),$(".entity-detail").append('<div style="text-align: center;"><span class="animation-wave"><span></span></span></div>'),$("#modal-entity-detail .modal-title").html(n),$("#modal-entity-detail").modal("show"),$.ajax({type:"GET",dataType:"html",url:i,data:a,success:function(e){$(".entity-detail").empty(),$(".entity-detail").append(e)}})}),$(document).on("click",".button-application-setting",function(e){e.preventDefault();let t=$("#modal-application-setting .button-save-application-config");t[0].disabled=!0;let a=$(this).closest(".application-item").attr("data-application-id");$("#modal-application-setting").modal("show"),$("#modal-application-setting .application-setting").empty(),$.ajax({type:"GET",url:"lib.ajax/application-setting.php",data:{applicationId:a},dataType:"html",success:function(e){$("#modal-application-setting .application-setting").empty().append(e),setTimeout(function(){$("#modal-application-setting .application-setting").find('[name="database_password"]').val("")},2e3),reloadApplicationList(),t[0].disabled=!1}})}),$(document).on("click",".button-application-menu",function(e){e.preventDefault();let t=$("#modal-application-setting .button-save-application-config");t[0].disabled=!0;let a=$(this).closest(".application-item").attr("data-application-id"),n=$("#modal-application-menu");n.find(".modal-body").empty(),n.find(".modal-body").append('<div style="text-align: center;"><span class="animation-wave"><span></span></span></div>'),n.attr("data-application-id",a),n.modal("show"),$.ajax({type:"GET",url:"lib.ajax/application-menu.php",data:{applicationId:a},dataType:"html",success:function(e){$("#modal-application-menu .modal-body").empty().append(e),reloadApplicationList(),t[0].disabled=!1,initMenu()}})}),$(document).on("click","#modal-application-menu .button-save-menu",function(e){e.preventDefault();let t=$(this).closest(".modal"),a=t.attr("data-application-id"),n=JSON.stringify(serializeMenu());$.ajax({type:"POST",url:"lib.ajax/application-menu-update.php",data:{applicationId:a,data:n},success:function(e){t.modal("hide"),loadMenu()}})}),$(document).on("click","#modal-application-menu .button-add-menu",function(e){e.preventDefault(),$("#new_menu").val("");$("#modal-application-menu-add").modal("show"),setTimeout(function(){$("#new_menu").val(""),$("#new_menu").focus()},600)}),$(document).on("click","#modal-application-menu-add .button-apply-new-menu",function(e){e.preventDefault();let t=$(this).closest(".modal"),a=!1,n=$("#new_menu").val(),i=serializeMenu();for(let l in i)i[l].label.toLowerCase()==n.toLowerCase()&&(a=!0);if(a)$("#new_menu").select();else{let o="";o+='<li class="sortable-menu-item">\r\n',o+='<span class="sortable-icon icon-move-up" onclick="moveUp(this)"></span>\r\n',o+='<span class="sortable-icon icon-move-down" onclick="moveDown(this)"></span>\r\n',o+='<span class="sortable-icon icon-move"></span>\r\n',o+='<a href="#">'+n+"</a>\r\n",o+='<span class="sortable-toggle-icon"></span>\r\n',o+='<ul class="sortable-submenu">\r\n',o+="</ul>\r\n";let r=$(o+="</li>\r\n");$(".sortable-menu").append(r);r.find(".sortable-toggle-icon")[0].addEventListener("click",function(){this.parentNode.classList.toggle("expanded")}),document.querySelectorAll(".sortable-submenu-item").forEach(e=>{e.setAttribute("draggable",!0),e.addEventListener("dragstart",dragStart),e.addEventListener("dragover",dragOver),e.addEventListener("drop",dropToSubmenu)}),r[0].addEventListener("dragover",dragOver),r[0].addEventListener("drop",dropToMenu),t.modal("hide")}}),$(document).on("click",".button-application-default",function(e){e.preventDefault();let t=$(this).closest(".application-item").attr("data-application-id");$.ajax({type:"POST",url:"lib.ajax/application-default.php",data:{applicationId:t},success:function(e){reloadApplicationList()}})}),$(document).on("click",".button-application-open",function(e){e.preventDefault();let t=$(this).closest(".application-item").attr("data-path");window.location="vscode://file/"+t}),$(document).on("click",".refresh-application-list",function(e){e.preventDefault(),reloadApplicationList()}),$(document).on("click",".button-save-workspace",function(e){e.preventDefault();let t=$(this).closest(".modal"),a=t.find('[name="workspace"]').val();$.ajax({type:"POST",url:"lib.ajax/workspace-update.php",data:{workspace:a},success:function(e){t.modal("hide")}})}),$(document).on("click",".sortable-menu-item > a, .sortable-submenu-item > a",function(e){e.preventDefault()}),$(document).on("dblclick",".sortable-menu-item > a, .sortable-submenu-item > a",function(e){e.preventDefault();let t=$(this).siblings(".icon-edit")[0];editMenu(t)}),$(document).on("blur",'.sortable-menu-item > input[type="text"], .sortable-submenu-item > input[type="text"]',function(e){e.preventDefault();let t=$(this),a=$(this).siblings("a.app-menu-text");t.css({display:"none"}),a.text(t.val()),a.css({display:""})}),$(document).on("click","#button_execute_entity_query",function(e){e.preventDefault(),$("#modal-query-executor").find("textarea").val(cmEditorSQL.getSelection()),$("#modal-query-executor").modal("show")}),$(document).on("change","table select[name=database_driver]",function(e){let t=$(this).find("option:selected").attr("data-base");$(this).closest("table").find("tr.database-credential").attr("data-current-database-type",t)}),$(document).on("blur keyup",'input[type="number"]',function(){isNaN($(this).val())||""===$(this).val().trim()?$(this).addClass("input-invalid-value"):$(this).removeClass("input-invalid-value")}),$(document).on("click","#test-database-connection",function(e){let t=$(this).closest("table"),a={testConnection:"test"};t.find(":input").each(function(e){void 0!=$(this).attr("name")&&""!=$(this).attr("name")&&(a[$(this).attr("name")]=$(this).val())}),$.ajax({type:"POST",url:"lib.ajax/database-test.php",data:a,dataType:"json",success:function(e){e.conneted1?e.conneted2?($("#create-database").css({display:"none"}),showAlertUI("Database Connection Test","Successfully connected to the database.")):($("#create-database").css({display:"inline"}),showAlertUI("Database Connection Test","Successfully connected to the server, but database not found.")):($("#create-database").css({display:"none"}),showAlertUI("Database Connection Test","Invalid database credentials."))},error:function(e,t,a){$("#create-database").css("display","none"),showAlertUI("Database Connection Test","There was an error connecting to the server: "+a)}})}),$(document).on("click","#create-database",function(e){let t=$(this).closest("table"),a={createDatabase:"create"};t.find(":input").each(function(e){void 0!=$(this).attr("name")&&""!=$(this).attr("name")&&(a[$(this).attr("name")]=$(this).val())}),$.ajax({type:"POST",url:"lib.ajax/database-create.php",data:a,dataType:"json",success:function(e){e.conneted1?e.conneted2?($("#create-database").css({display:"none"}),showAlertUI("Database Connection Test","Successfully created and connected to the database.")):($("#create-database").css({display:"inline"}),showAlertUI("Database Connection Test","Successfully connected to the server, but database creation failed.")):($("#create-database").css({display:"none"}),showAlertUI("Database Connection Test","Invalid database credentials."))},error:function(e,t,a){$("#create-database").css("display","none"),showAlertUI("Database Connection Test","There was an error connecting to the server: "+a)}})}),reloadApplicationList(),loadTable(),loadMenu(),updateEntityQuery(!1),updateEntityRelationshipDiagram(),updateEntityFile(),updateModuleFile(),initTooltip()});let timeoutEditMenu=setTimeout("",100);function initMenu(){document.querySelectorAll(".sortable-toggle-icon").forEach(e=>{e.addEventListener("click",function(){this.parentNode.classList.toggle("expanded")})}),document.querySelectorAll(".sortable-submenu-item").forEach(e=>{e.setAttribute("draggable",!0),e.addEventListener("dragstart",dragStart),e.addEventListener("dragover",dragOver),e.addEventListener("drop",dropToSubmenu)}),document.querySelectorAll(".icon-move-down").forEach(e=>{e.setAttribute("draggable",!0),e.addEventListener("dragstart",dragStart)}),document.querySelectorAll(".sortable-menu-item").forEach(e=>{e.addEventListener("dragover",dragOver),e.addEventListener("drop",dropToMenu)})}function editMenu(e){let t=$(e),a=t.closest("li"),n=t.siblings(".app-menu-text");a.find("input")&&a.find("input").remove();let i=$("<input />");i.attr({type:"text",class:"form-control"}),n.css("display","none"),n.before(i),i.val(n.text()),i.focus(),i.select(),i.focus()}function editSubmenu(e){let t=$(e).siblings(".app-submenu");console.log(t.text())}let draggedItem=null;function dragStart(e){if(e.target.classList.contains("sortable-submenu-item"))draggedItem=e.target,e.dataTransfer.effectAllowed="move";else{let t=e.target.closest(".sortable-submenu-item");null!=t&&(draggedItem=t,t.dataTransfer&&(t.dataTransfer.effectAllowed="move"))}}function dragOver(e){e.preventDefault()}function dropToMenu(e){if(e.preventDefault(),draggedItem){if(0===e.target.classList.length){let t=e.target.closest(".sortable-menu-item");t&&(t.querySelector(".sortable-submenu").appendChild(draggedItem),t.classList.remove("expanded"),t.classList.add("expanded"))}if(e.target.classList.contains("sortable-menu-item")){if(!e.target.querySelector(".sortable-submenu")){let a=document.createElement("ul");a.classList.add("sortable-submenu"),e.target.appendChild(a)}e.target.querySelector(".sortable-submenu").appendChild(draggedItem),e.target.classList.remove("expanded"),e.target.classList.add("expanded")}(e.target.classList.contains("sortable-submenu")||e.target.classList.contains("icon-move"))&&(e.target.appendChild(draggedItem),e.target.parentNode.classList.remove("expanded"),e.target.parentNode.classList.add("expanded")),draggedItem=null}}function dropToSubmenu(e){if(e.preventDefault(),e.target.classList.contains("sortable-submenu-item")){let t=e.offsetY>e.target.offsetHeight/2;t?e.target.parentNode.insertBefore(draggedItem,e.target.nextSibling):e.target.parentNode.insertBefore(draggedItem,e.target)}else e.target.classList.contains("sortable-submenu")&&e.target.appendChild(draggedItem)}function serializeMenu(){let e=[],t=document.querySelectorAll(".sortable-menu-item");return t.forEach(t=>{let a={label:t.querySelector("a.app-menu-text").textContent,submenus:[]},n=t.querySelectorAll(".sortable-submenu-item");n.forEach(e=>{a.submenus.push({label:e.querySelector("a.app-menu-text").textContent,link:e.querySelector("a.app-menu-text").getAttribute("href")})}),e.push(a)}),e}function moveUp(e){let t=e.closest(".sortable-submenu-item")||e.closest(".sortable-menu-item"),a=t.previousElementSibling;a&&t.parentNode.insertBefore(t,a)}function moveDown(e){let t=e.closest(".sortable-submenu-item")||e.closest(".sortable-menu-item"),a=t.nextElementSibling;a&&t.parentNode.insertBefore(a,t)}function reloadApplicationList(){$.ajax({type:"GET",url:"lib.ajax/application-list.php",success:function(e){$(".application-card").empty().append(e)}}),$.ajax({type:"GET",url:"lib.ajax/path-list.php",dataType:"json",success:function(e){for(let t in $('[name="current_module_location"]').empty(),e)$('[name="current_module_location"]')[0].append(new Option(e[t].name+" - "+e[t].path,e[t].path,e[t].active,e[t].active))}})}function reloadTranslate(e){"module"==e?translateModule():"entity"==e&&translateEntity()}function translateEntity(e){if(""!=(entityName=currentEntity2Translated)){let t=$(".target-language").val(),a=$(".filter-translate").val();$.ajax({method:"POST",url:"lib.ajax/entity-translate.php",dataType:"json",data:{userAction:"get",entityName:entityName,targetLanguage:t,filter:a},success:function(e){let t=[],a=[],n=[];for(let i in e)t.push(e[i].original),a.push(e[i].translated),n.push(e[i].propertyName);transEd1.getDoc().setValue(t.join("\r\n")),transEd2.getDoc().setValue(a.join("\r\n")),$(".entity-property-name").val(n.join("|")),$(".entity-name").val(entityName),focused={},transEd1.removeLineClass(lastLine1,"background","highlight-line"),transEd2.removeLineClass(lastLine1,"background","highlight-line"),lastLine1=-1}})}void 0!==e&&e()}function translateModule(){let e=$(".target-language").val(),t=$(".filter-translate").val(),a=[];$(".module-for-translate").each(function(e){$(this)[0].checked&&a.push($(this).val())}),$.ajax({method:"POST",url:"lib.ajax/module-translate.php",dataType:"json",data:{userAction:"get",modules:a,translated:null,propertyNames:null,targetLanguage:e,filter:t},success:function(e){let t=[],a=[],n=[];for(let i in e)t.push(e[i].original),a.push(e[i].translated),n.push(e[i].propertyName);transEd3.getDoc().setValue(t.join("\r\n")),transEd4.getDoc().setValue(a.join("\r\n")),$(".module-property-name").val(n.join("|")),focused={},transEd3.removeLineClass(lastLine2,"background","highlight-line"),transEd4.removeLineClass(lastLine2,"background","highlight-line"),lastLine2=-1}})}function upperCamelize(e){return e.replaceAll("_"," ").capitalize().prettify().replaceAll(" ","").trim()}function hasKey(e,t){let a=e.length,n;for(n=0;n<a;n++)if(e[n].value==t)return!0;return!1}function loadState(e,t,a){let n;for(n in a.find("tbody tr").each(function(t,n){let i=$(this).find('input[type="hidden"][name="field"]').val();hasKey(e,i)&&$(a).find('input[name$="'+i+'"]').each(function(e,t){$(this)[0].checked=!1})}),e){let i=$(a).find(":input[name="+e[n].name+"]");if(i.length){let l=e[n].value,o=e[n].name,r=i.prop("tagName").toString().toLowerCase(),d=i.attr("type");"radio"==d?$(a).find('[name="'+o+'"][value="'+l+'"]')[0].checked=!0:"checkbox"==d&&null!=l&&0!=l&&"0"!=l?$(a).find('[name="'+o+'"]')[0].checked=!0:"select"==r&&i.val(e[n].value)}}}function fixPathForm(){let e=0;$("table.path-manager tbody tr").each(function(){let t=$(this);t.find('td:nth-child(1) input[type="text"]').attr("name","name["+e+"]"),t.find('td:nth-child(2) input[type="text"]').attr("name","path["+e+"]"),t.find('td:nth-child(3) input[type="checkbox"]').attr("name","checked["+e+"]"),e++})}function fixLanguageForm(){let e=0;$("table.language-manager tbody tr").each(function(){let t=$(this);t.find('td:nth-child(1) input[type="text"]').attr("name","language_name["+e+"]"),t.find('td:nth-child(2) input[type="text"]').attr("name","language_code["+e+"]"),t.find('td:nth-child(3) input[type="checkbox"]').attr("name","checked["+e+"]"),e++})}function addDiagramOption(e){return e.push("maximum_level="+$('[name="maximum_level"]').val()),e.push("maximum_column="+$('[name="maximum_column"]').val()),e.push("margin_x="+$('[name="margin_x"]').val()),e.push("margin_y="+$('[name="margin_y"]').val()),e.push("entity_margin_x="+$('[name="entity_margin_x"]').val()),e.push("entity_margin_y="+$('[name="entity_margin_y"]').val()),e.push("zoom="+$('[name="zoom"]').val()),e}function loadDiagramMultiple(){let e=[];e=addDiagramOption(e),$(".entity-container-relationship .entity-checkbox").each(function(){$(this)[0].checked&&e.push("entity[]="+$(this).val())}),e.push("rnd="+new Date().getTime());let t=$("<img />"),a="lib.ajax/entity-relationship-diagram.php?"+e.join("&"),n="lib.ajax/entity-relationship-diagram-map.php?"+e.join("&");t.attr("src",a),$(".erd-image").empty().append(t),$('[name="erd-map"]').load(n,function(){t.attr("usemap","#erd-map")})}function downloadSVG(){let e=document.querySelector(".erd-image img"),t=e.getAttribute("src");window.open(t)}function downloadPNG(){let e=document.querySelector(".erd-image img"),t=e.getAttribute("src"),a=document.createElement("canvas"),n=a.getContext("2d");a.width=e.width,a.height=e.height;let i=new Image;i.onload=function(){n.drawImage(i,0,0),URL.revokeObjectURL(t);let e=a.toDataURL("image/png");window.open(e)},i.src=t}function onChangeMapKey(e){let t=e.val();"label"==t.toLowerCase()||"value"==t.toLowerCase()||"default"==t.toLowerCase()?e.hasClass("input-invalid-value")||(e.addClass("input-invalid-value"),setTimeout(function(){e.val("data-"+t.toLowerCase()),onChangeMapKey(e)},500)):e.hasClass("input-invalid-value")&&e.removeClass("input-invalid-value")}function showAlertUI(e,t){$("#alert-dialog .modal-title").text(e),$("#alert-dialog .modal-body").html(t),$("#alert-dialog").modal("show")}function closeAlertUI(){$("#alert-dialog").modal("hide")}function saveModule(){if(""!=currentModule){$("#button_save_module_file").attr("disabled","disabled");let e=cmEditorModule.getDoc().getValue();$.ajax({type:"POST",url:"lib.ajax/module-update.php",data:{content:e,module:currentModule},dataType:"html",success:function(e){$("#button_save_module_file").removeAttr("disabled")}})}else showAlertUI("Alert","No file open")}function saveEntity(){if(""!=currentEntity){$("#button_save_entity_file").attr("disabled","disabled");let e=cmEditorFile.getDoc().getValue();$.ajax({type:"POST",url:"lib.ajax/entity-update.php",dataType:"json",data:{content:e,entity:currentEntity},success:function(e){$("#button_save_entity_file").removeAttr("disabled"),updateEntityFile(),updateEntityQuery(!0),updateEntityRelationshipDiagram(),removeHilightLineError(),addHilightLineError(e.error_line-1),e.success||(showAlertUI(e.title,e.message),setTimeout(function(){closeAlertUI()},2e3))}})}else showAlertUI("Alert","No file open")}function addHilightLineError(e){-1!=e&&cmEditorFile.addLineClass(e,"background","highlight-line"),lastErrorLine=e}function removeHilightLineError(){-1!=lastErrorLine&&cmEditorFile.removeLineClass(lastErrorLine,"background","highlight-line")}function saveQuery(){let e=new Blob([cmEditorSQL.getDoc().getValue()],{type:"application/x-sql;charset=utf-8"}),t=$("#current_application").val();saveAs(e,t+"-"+new Date().getTime()+".sql")}function getEntitySelection(){let e=[];return $(".entity-checkbox").each(function(){$(this)[0].checked&&e.push($(this).val())}),e}function getEntityQuery(e,t){$.ajax({type:"POST",url:"lib.ajax/entity-query.php",data:{entity:e,merged:t?1:0},dataType:"text",success:function(e){cmEditorSQL.getDoc().setValue(e),setTimeout(function(){cmEditorSQL.refresh()},1),$("#button_save_entity_query").removeAttr("disabled")}})}function getEntityFile(e,t){$.ajax({type:"POST",url:"lib.ajax/entity-file.php",data:{entity:e},dataType:"text",success:function(a){cmEditorFile.getDoc().setValue(a),setTimeout(function(){cmEditorFile.refresh()},1),$("#button_save_entity_file").removeAttr("disabled"),currentEntity=e[0],t&&t()}})}function getModuleFile(e,t){$.ajax({type:"GET",url:"lib.ajax/module-file.php",data:{module:e},dataType:"html",success:function(a){cmEditorModule.getDoc().setValue(a),setTimeout(function(){cmEditorModule.refresh()},1),$("#button_save_module_file").removeAttr("disabled"),currentModule=e,t&&t()}})}function updateEntityQuery(e){e=e||!1,$.ajax({type:"GET",url:"lib.ajax/entity-list-with-checkbox.php",data:{autoload:e},dataType:"html",success:function(t){$(".entity-container-query .entity-list").empty().append(t);let a=getEntitySelection(),n=$(".entity-merge")[0].checked;e&&getEntityQuery(a,n)}})}function updateEntityRelationshipDiagram(){$.ajax({type:"GET",url:"lib.ajax/entity-list-for-diagram.php",dataType:"html",success:function(e){$(".entity-container-relationship .entity-list").empty().append(e)}})}function updateEntityFile(){$.ajax({type:"GET",url:"lib.ajax/entity-list.php",dataType:"html",success:function(e){$(".entity-container-file .entity-list").empty().append(e),$(".container-translate-entity .entity-list").empty().append(e)}})}function updateModuleFile(){$.ajax({type:"GET",url:"lib.ajax/module-list-file.php",dataType:"html",success:function(e){$(".module-container .module-list-file").empty().append(e)}}),$.ajax({type:"GET",url:"lib.ajax/module-list-translate.php",dataType:"html",success:function(e){$(".container-translate-module .module-list-translate").empty().append(e)}})}function saveReference(e,t,a){$.ajax({type:"POST",url:"lib.ajax/reference-save.php",data:{fieldName:e,key:t,value:a},dataType:"json",success:function(e){}})}function loadReference(e,t,a){$.ajax({type:"GET",url:"lib.ajax/reference-load.php",data:{fieldName:e,key:t},dataType:"json",success:function(e){a(e)}})}function updateTableName(e,t,a,n,i){e=e.replaceAll("_","-"),t=t.replaceAll("_","-"),a=ucWord(a.replaceAll("_"," "));let l=upperCamelize(n),o=n+"_apv",r=n+"_trash";$(this).attr("data-value",n),$('[name="primary_key_master"]').val(i),$('[name="entity_master_name"]').val(l),$('[name="entity_approval_name"]').val(l+"Apv"),$('[name="entity_trash_name"]').val(l+"Trash"),$('[name="table_approval_name"]').val(o),$('[name="primary_key_approval"]').val(o+"_id"),$('[name="table_trash_name"]').val(r),$('[name="primary_key_trash"]').val(r+"_id"),$('[name="module_file"]').val(e),$('[name="module_code"]').val(t),$('[name="module_name"]').val(a)}function ucWord(e){return(e=e.toLowerCase()).replace(/(^([a-zA-Z\p{M}]))|([ -][a-zA-Z\p{M}])/g,function(e){return e.toUpperCase()})}function prepareReferenceData(e,t){let a=t.closest("tr");"select"==e?a.find(".reference_button_data").css("display","inline"):a.find(".reference_button_data").css("display","none")}function prepareReferenceFilter(e,t){let a=t.closest("tr");"select"==e?a.find(".reference_button_filter").css("display","inline"):a.find(".reference_button_filter").css("display","none")}function switchApplication(e){$.ajax({type:"post",url:"lib.ajax/application-switch.php",dataType:"json",data:{currentApplication:e},success:function(e){window.location.reload()}})}function generateScript(e){let t=[];$(e).find("tr").each(function(e){let a=$(this).attr("data-field-name"),n=$(this).find("input.input-field-name").val(),i=$(this).find("input.include_insert")[0].checked,l=$(this).find("input.include_edit")[0].checked,o=$(this).find("input.include_detail")[0].checked,r=$(this).find("input.include_list")[0].checked,d=$(this).find("input.include_export")[0].checked,c=$(this).find("input.include_key")[0].checked,s=$(this).find("input.include_required")[0].checked,u=$(this).find("input.input-element-type:checked").val(),p=$(this).find("input.input-field-filter:checked").length>0?$(this).find("input.input-field-filter:checked").val():null,m=$(this).find("select.input-field-data-type").val(),f=$(this).find("select.input-data-filter").val(),h=parseJsonData($(this).find("input.reference-data").val()),y=parseJsonData($(this).find("input.reference-filter").val());t.push({fieldName:a,fieldLabel:n,includeInsert:i,includeEdit:l,includeDetail:o,includeList:r,includeExport:d,isKey:c,isInputRequired:s,elementType:u,filterElementType:p,dataType:m,inputFilter:f,referenceData:h,referenceFilter:y})});let a=$("#subquery")[0].checked&&!0,n=$("#with_approval")[0].checked&&!0,i=$("#with_trash")[0].checked&&!0,l=$("#manualsortorder")[0].checked&&!0,o=$("#export_to_excel")[0].checked&&!0,r=$("#export_to_csv")[0].checked&&!0,d=$("#activate_deactivate")[0].checked&&!0,c=$("#with_approval_note")[0].checked&&!0,s=$('[name="approval_position"]:checked').val(),u=$('[name="approval_type"]:checked').val(),p=$("#ajax_support")[0].checked&&!0,m={mainEntity:{entityName:$('[name="entity_master_name"]').val(),tableName:$('[name="source_table"]').val(),primaryKey:$('[name="primary_key_master"]').val()},approvalRequired:n,trashRequired:i};n&&(m.approvalEntity={entityName:$('[name="entity_approval_name"]').val(),tableName:$('[name="table_approval_name"]').val(),primaryKey:$('[name="primary_key_approval"]').val()}),i&&(m.trashEntity={entityName:$('[name="entity_trash_name"]').val(),tableName:$('[name="table_trash_name"]').val(),primaryKey:$('[name="primary_key_trash"]').val()});let f=getSpecificationModule(),h=getSortableModule(),y={entity:m,fields:t,specification:f,sortable:h,features:{subquery:a,activateDeactivate:d,sortOrder:l,exportToExcel:o,exportToCsv:r,approvalRequired:n,approvalNote:c,trashRequired:i,approvalType:u,approvalPosition:s,ajaxSupport:p},moduleCode:$('[name="module_code"]').val(),moduleName:$('[name="module_name"]').val(),moduleFile:$('[name="module_file"]').val(),moduleAdMenu:$('[name="module_as_menu"]').val(),moduleMenu:$('[name="module_menu"]').val(),target:$("#current_module_location").val(),updateEntity:$('[name="update_entity"]')[0].checked};generateAllCode(y)}function getSpecificationModule(){let e=[];return $(".table-data-filter").find("tbody").find("tr").each(function(t){let a=$(this);if(a.find(".data-filter-column-name").length&&a.find(".data-filter-column-value").length){let n=a.find(".data-filter-column-name").val(),i=a.find(".data-filter-column-value").val();n=n?n.trim():"",i=i?i.trim():"",n.length>0&&e.push({column:n,value:i})}}),e}function getSortableModule(){let e=[];return $(".table-data-order").find("tbody").find("tr").each(function(t){let a=$(this);if(a.find(".data-order-column-name").length&&a.find(".data-order-order-type").length){let n=a.find(".data-order-column-name").val(),i=a.find(".data-order-order-type").val();n=n?n.trim():"",i=i?i.trim():"",n.length>0&&e.push({sortBy:n,sortType:i})}}),e}function parseJsonData(e){if("string"!=typeof e)return null;try{let t=JSON.parse(e);if("object"==typeof t)return t}catch(a){}return null}function parseJsonData(e){if("string"!=typeof e)return null;try{let t=JSON.parse(e);if("object"==typeof t)return t}catch(a){}return null}function generateAllCode(e){$.ajax({type:"post",url:"lib.ajax/script-generator.php",dataType:"json",data:e,success:function(e){updateEntityFile(),updateEntityQuery(!0),updateEntityRelationshipDiagram(),e.success&&(showAlertUI(e.title,e.message),setTimeout(function(){closeAlertUI()},2e3))}})}function updateCurrentApplivation(e){$.ajax({type:"POST",url:"lib.ajax/application-update.php",data:e,success:function(e){for(let t in $('select[name="source_table"]').empty(),e)$('select[name="source_table"]')[0].append(new Option(e[t].table_name,e[t].table_name));let a=$('select[name="source_table"]').attr("data-value");null!=a&&""!=a&&$('select[name="source_table"]').val(a),reloadApplicationList()}})}function loadTable(){$.ajax({type:"post",url:"lib.ajax/database-table-list.php",dataType:"json",success:function(e){for(let t in $('select[name="source_table"]').empty(),$('select[name="source_table"]')[0].append(new Option("- Select Table -","")),e)e.hasOwnProperty(t)&&$('select[name="source_table"]')[0].append(new Option(e[t].table_name,e[t].table_name));$('select[name="source_table"]').find("option").each(function(t){let a=$(this).attr("value")||"";""!=a&&void 0!==e[a]&&void 0!==e[a].primary_key&&void 0!==e[a].primary_key[0]&&$(this).attr("data-primary-key",e[a].primary_key[0])});let a=$('select[name="source_table"]').attr("data-value");null!=a&&""!=a&&$('select[name="source_table"]').val(a)}})}function loadMenu(){$.ajax({type:"get",url:"lib.ajax/application-menu-json.php",dataType:"json",success:function(e){for(let t in $('select[name="module_menu"]').empty(),e)e.hasOwnProperty(t)&&$('select[name="module_menu"]')[0].append(new Option(e[t].label,e[t].label))}})}function loadColumn(e,t){$.ajax({type:"post",url:"lib.ajax/database-column-list.php",data:{table_name:e},dataType:"json",success:function(e){$(t).empty();let a=e.fields,n,i,l,o,r=getSkipedCol();for(n in a)o=generateRow(i=a[n].column_name,l={data_type:a[n].data_type,column_type:a[n].column_type},r),$(t).append(o);if(void 0!==e.primary_keys&&e.primary_keys.length)for(let d in e.primary_keys){let c=e.primary_keys[d];$('[data-field-name="'+c+'"]').find('[name="include_key_'+c+'"]')[0].checked=!0}$('[name="module_load_previous"]')[0].checked?loadSavedModuleData($("#module_file").val(),$("#current_module_location").val(),function(){$(".define-wrapper").css("display","block"),$("#define-column-tab").click()}):($(".define-wrapper").css("display","block"),$("#define-column-tab").click())}})}function restoreForm(e){if(void 0!==e.fields){for(let t in e.fields)if(e.fields.hasOwnProperty(t)){let a=$('.main-table tbody tr[data-field-name="'+e.fields[t].fieldName+'"]');a.length>0&&(a.appendTo(a.parent()),a.find(".include_insert")[0].checked=!0===e.fields[t].includeInsert||"true"==e.fields[t].includeInsert,a.find(".include_edit")[0].checked=!0===e.fields[t].includeEdit||"true"==e.fields[t].includeEdit,a.find(".include_detail")[0].checked=!0===e.fields[t].includeDetail||"true"==e.fields[t].includeDetail,a.find(".include_list")[0].checked=!0===e.fields[t].includeList||"true"==e.fields[t].includeList,a.find(".include_export")[0].checked=!0===e.fields[t].includeExport||"true"==e.fields[t].includeExport,a.find(".include_key")[0].checked=!0===e.fields[t].isKey||"true"==e.fields[t].isKey,a.find(".include_required")[0].checked=!0===e.fields[t].isInputRequired||"true"==e.fields[t].isInputRequired,a.find('.input-element-type[value="'+e.fields[t].elementType+'"]')[0].checked=!0,"select"==e.fields[t].elementType&&(a.find(".reference-data").val(JSON.stringify(e.fields[t].referenceData)),a.find(".reference_button_data").css("display","inline")),"select"==e.fields[t].filterElementType&&(a.find(".reference-filter").val(JSON.stringify(e.fields[t].referenceFilter)),a.find(".reference_button_filter").css("display","inline"),a.find('.input-field-filter[value="select"]')[0].checked=!0),"text"==e.fields[t].filterElementType&&(a.find('.input-field-filter[value="text"]')[0].checked=!0),a.find(".input-field-data-type").val(e.fields[t].dataType),a.find(".input-data-filter").val(e.fields[t].inputFilter))}}let n,i;for(n=0,i="#modal-filter-data tbody tr:last-child";$("#modal-filter-data tbody tr").length>1;)$(i).remove();if($(i).find(".data-filter-column-name").val(""),$(i).find(".data-filter-column-value").val(""),void 0===e.specification||0==e.specification.length)$(i).find(".data-filter-column-name").val(""),$(i).find(".data-filter-column-value").val("");else for(let l in e.specification)if(e.specification.hasOwnProperty(l)){if(n>0){let o=$(i)[0].outerHTML;$(i).parent().append(o)}$(i).find(".data-filter-column-name").val(e.specification[l].column),$(i).find(".data-filter-column-value").val(e.specification[l].value),n++}for(n=0,i="#modal-order-data tbody tr:last-child";$("#modal-order-data tbody tr").length>1;)$(i).remove();if($(i).find(".data-filter-column-name").val(""),$(i).find(".data-filter-column-value").val(""),void 0===e.sortable||0==e.sortable.length)$(i).find(".data-order-column-name").val(""),$(i).find(".data-order-order-type").val("PicoSort::ORDER_TYPE_ASC");else for(let r in e.sortable)if(e.sortable.hasOwnProperty(r)){if(n>0){let d=$(i)[0].outerHTML;$(i).parent().append(d)}$(i).find(".data-order-column-name").val(e.sortable[r].sortBy),$(i).find(".data-order-order-type").val(e.sortable[r].sortType),n++}void 0!==e.features&&($('#modal-module-features [name="subquery"]').length&&($('#modal-module-features [name="subquery"]')[0].checked=!0===e.features.subquery||"true"==e.features.subquery),$('#modal-module-features [name="activate_deactivate"]').length&&($('#modal-module-features [name="activate_deactivate"]')[0].checked=!0===e.features.activateDeactivate||"true"==e.features.activateDeactivate),$('#modal-module-features [name="manualsortorder"]').length&&($('#modal-module-features [name="manualsortorder"]')[0].checked=!0===e.features.sortOrder||"true"==e.features.sortOrder),$('#modal-module-features [name="export_to_excel"]').length&&($('#modal-module-features [name="export_to_excel"]')[0].checked=!0===e.features.exportToExcel||"true"==e.features.exportToExcel),$('#modal-module-features [name="export_to_csv"]').length&&($('#modal-module-features [name="export_to_csv"]')[0].checked=!0===e.features.exportToCsv||"true"==e.features.exportToCsv),$('#modal-module-features [name="with_approval"]').length&&($('#modal-module-features [name="with_approval"]')[0].checked=!0===e.features.approvalRequired||"true"==e.features.approvalRequired),$('#modal-module-features [name="with_approval_note"]').length&&($('#modal-module-features [name="with_approval_note"]')[0].checked=!0===e.features.approvalNote||"true"==e.features.approvalNote),$('#modal-module-features [name="with_trash"]').length&&($('#modal-module-features [name="with_trash"]')[0].checked=!0===e.features.trashRequired||"true"==e.features.trashRequired),$('#modal-module-features [name="approval_type"][value="'+e.features.approvalType+'"]').length&&($('#modal-module-features [name="approval_type"][value="'+e.features.approvalType+'"]')[0].checked=!0),$('#modal-module-features [name="approval_position"][value="'+e.features.approvalPosition+'"]').length&&($('#modal-module-features [name="approval_position"][value="'+e.features.approvalPosition+'"]')[0].checked=!0),$('#modal-module-features [name="ajax_support"]').length&&($('#modal-module-features [name="ajax_support"]')[0].checked=!0===e.features.ajaxSupport||"true"==e.features.ajaxSupport))}function loadSavedModuleData(e,t,a){$.ajax({type:"GET",url:"lib.ajax/module-data.php",data:{moduleFile:e,target:t},dataType:"json",success:function(e){restoreForm(e),a()},error:function(e){a()}})}function getSkipedCol(){let e=[];return e.push($('[name="entity_info_draft"]').val()),e.push($('[name="entity_info_waiting_for"]').val()),e.push($('[name="entity_info_approval_note"]').val()),e.push($('[name="entity_info_approval_id"]').val()),e.push($('[name="entity_info_admin_create"]').val()),e.push($('[name="entity_info_admin_edit"]').val()),e.push($('[name="entity_info_admin_ask_edit"]').val()),e.push($('[name="entity_info_time_create"]').val()),e.push($('[name="entity_info_time_edit"]').val()),e.push($('[name="entity_info_time_ask_edit"]').val()),e.push($('[name="entity_info_ip_create"]').val()),e.push($('[name="entity_info_ip_edit"]').val()),e.push($('[name="entity_info_ip_ask_edit"]').val()),e}function generateSelectFilter(e,t){let a;(t=t||{}).column_type=t.column_type||"text";let n=t.column_type,i={FILTER_SANITIZE_BOOL:["tinyint(1)","bool","boolean",],FILTER_SANITIZE_NUMBER_INT:["bit","varbit","smallint","int","integer","bigint","smallserial","serial","bigserial","tinyint",],FILTER_SANITIZE_NUMBER_FLOAT:["numeric","double","real","money"],FILTER_SANITIZE_SPECIAL_CHARS:["char","character","varchar","character varying","text","date","timestamp","time",]};a=$('<select class="form-control input-data-filter" name="filter_type_'+e+'" id="filter_type_'+e+'">\r\n<option value="FILTER_DEFAULT">DEFAULT</option>\r\n<option value="FILTER_SANITIZE_BOOL">BOOL</option>\r\n<option value="FILTER_SANITIZE_NUMBER_INT">NUMBER_INT</option>\r\n<option value="FILTER_SANITIZE_NUMBER_UINT">NUMBER_UINT</option>\r\n<option value="FILTER_SANITIZE_NUMBER_OCTAL">NUMBER_OCTAL</option>\r\n<option value="FILTER_SANITIZE_NUMBER_HEXADECIMAL">NUMBER_HEXADECIMAL</option>\r\n<option value="FILTER_SANITIZE_NUMBER_FLOAT">NUMBER_FLOAT</option>\r\n<option value="FILTER_SANITIZE_STRING">STRING</option>\r\n<option value="FILTER_SANITIZE_STRING_INLINE">STRING_INLINE</option>\r\n<option value="FILTER_SANITIZE_NO_DOUBLE_SPACE">NO_DOUBLE_SPACE</option>\r\n<option value="FILTER_SANITIZE_STRIPPED">STRIPPED</option>\r\n<option value="FILTER_SANITIZE_SPECIAL_CHARS">SPECIAL_CHARS</option>\r\n<option value="FILTER_SANITIZE_ALPHA">ALPHA</option>\r\n<option value="FILTER_SANITIZE_ALPHANUMERIC">ALPHANUMERIC</option>\r\n<option value="FILTER_SANITIZE_ALPHANUMERICPUNC">ALPHANUMERICPUNC</option>\r\n<option value="FILTER_SANITIZE_STRING_BASE64">STRING_BASE64</option>\r\n<option value="FILTER_SANITIZE_EMAIL">EMAIL</option>\r\n<option value="FILTER_SANITIZE_URL">URL</option>\r\n<option value="FILTER_SANITIZE_IP">IP</option>\r\n<option value="FILTER_SANITIZE_ENCODED">ENCODED</option>\r\n<option value="FILTER_SANITIZE_COLOR">COLOR</option>\r\n<option value="FILTER_SANITIZE_MAGIC_QUOTES">MAGIC_QUOTES</option>\r\n<option value="FILTER_SANITIZE_PASSWORD">PASSWORD</option>\r\n</select>\r\n');let l,o,r,d="FILTER_SANITIZE_SPECIAL_CHARS",c=!1;for(l in i){for(r in o=i[l])if(-1!=n.indexOf(o[r])){d=l,c=!0;break}if(c)break}return a.find("option").each(function(e,t){$(this).removeAttr("selected")}),a.find('option[value="'+d+'"]').attr("selected","selected"),a[0].outerHTML}function generateSelectType(e,t){let a;(t=t||{}).data_type=t.data_type||"text";let n=t.data_type,i={int:["bit","varbit","smallint","int","integer","bigint","smallserial","serial","bigserial","bool","boolean",],float:["numeric","double","real","money"],text:["char","character","varchar","character varying","text"],"datetime-local":["datetime","timestamp"],date:["date"],time:["time"]};a=$('<select class="form-control input-field-data-type" name="data_type_'+e+'" id="data_type_'+e+'">\r\n<option value="text" title="&lt;input type=&quot;text&quot;&gt;">text</option>\r\n<option value="email" title="&lt;input type=&quot;email&quot;&gt;">email</option>\r\n<option value="url" title="&lt;input type=&quot;email&quot;&gt;">url</option>\r\n<option value="tel" title="&lt;input type=&quot;tel&quot;&gt;">tel</option>\r\n<option value="password" title="&lt;input type=&quot;password&quot;&gt;">password</option>\r\n<option value="int" title="&lt;input type=&quot;number&quot;&gt;">int</option>\r\n<option value="float" title="&lt;input type=&quot;number&quot; step=&quot;any&quot;&gt;">float</option>\r\n<option value="date" title="&lt;input type=&quot;text&date;&gt;">date</option>\r\n<option value="time" title="&lt;input type=&quot;time&quot;&gt;">time</option>\r\n<option value="datetime-local" title="&lt;input type=&quot;datetime-local&quot;&gt;">datetime</option>\r\n<option value="week" title="&lt;input type=&quot;week&quot;&gt;">week</option>\r\n<option value="color" title="&lt;input type=&quot;color&quot;&gt;">color</option>\r\n</select>\r\n');let l,o,r,d="text",c=!1;for(l in i){for(r in o=i[l])if(-1!=n.indexOf(o[r])){d=l,c=!0;break}if(c)break}return a.find("option").each(function(e,t){$(this).removeAttr("selected")}),a.find('option[value="'+d+'"]').attr("selected","selected"),a[0].outerHTML}function arrayUnique(e){let t,a=[];for(t=0;t<e.length;t++)-1==a.indexOf(e[t])&&a.push(e[t]);return a}function isKeyWord(e){e=e.toString();let t,a=keyWords.split(",");for(t in a)if(e.equalIgnoreCase(a[t]))return!0;return!1}function generateRow(e,t,a){let n=isKeyWord(e),i=[],l="";i.push("row-column"),n&&i.push("reserved"),l=' class="'+i.join(" ")+'"';let o="",r="",d="",c="";return -1!=$.inArray(e,a)?(o='  <td align="center"><input type="checkbox" class="include_insert" name="include_insert_'+e+'" value="0" disabled="disabled"></td>\r\n',r='  <td align="center"><input type="checkbox" class="include_edit" name="include_edit_'+e+'" value="0" disabled="disabled"></td>\r\n',d='  <td align="center"><input type="checkbox" class="include_list" name="include_list_'+e+'" value="1"></td>\r\n'):(o='  <td align="center"><input type="checkbox" class="include_insert" name="include_insert_'+e+'" value="1" checked="checked"></td>\r\n',r='  <td align="center"><input type="checkbox" class="include_edit" name="include_edit_'+e+'" value="1" checked="checked"></td>\r\n',d='  <td align="center"><input type="checkbox" class="include_list" name="include_list_'+e+'" value="1" checked="checked"></td>\r\n'),c='  <td align="center"><input type="checkbox" class="include_export" name="include_export_'+e+'" value="1" checked="checked"></td>\r\n','<tr data-field-name="'+e+'" '+l+'>\r\n  <td class="data-sort data-sort-body data-sort-handler"></td>\r\n  <td class="field-name">'+e+'<input type="hidden" name="field" value="'+e+'"></td>\r\n  <td><input type="hidden" class="input-field-name" name="caption_'+e+'" value="'+e.replaceAll("_"," ").capitalize().prettify().trim()+'" autocomplete="off" spellcheck="false">'+e.replaceAll("_"," ").capitalize().prettify().trim()+"</td>\r\n"+o+r+'  <td align="center"><input type="checkbox" class="include_detail" name="include_detail_'+e+'" value="1" checked="checked"></td>\r\n'+d+c+'  <td align="center"><input type="checkbox" class="include_key" name="include_key_'+e+'" value="1"></td>\r\n  <td align="center"><input type="checkbox" class="include_required" name="include_required_'+e+'" value="1"></td>\r\n  <td align="center"><input type="radio" class="input-element-type" name="element_type_'+e+'" value="text" checked="checked"></td>\r\n  <td align="center"><input type="radio" class="input-element-type" name="element_type_'+e+'" value="textarea"></td>\r\n  <td align="center"><input type="radio" class="input-element-type" name="element_type_'+e+'" value="checkbox"></td>\r\n  <td align="center"><input type="radio" class="input-element-type" name="element_type_'+e+'" value="select"></td>\r\n  <td align="center"><input type="hidden" class="reference-data" name="reference_data_'+e+'" value="{}"><button type="button" class="btn btn-sm btn-primary reference-button reference_button_data">Source</button></td>\r\n  <td align="center"><input type="checkbox" name="list_filter_'+e+'" value="text" class="input-field-filter"></td>\r\n  <td align="center"><input type="checkbox" name="list_filter_'+e+'" value="select" class="input-field-filter"></td>\r\n  <td align="center"><input type="hidden" class="reference-filter" name="reference_filter_'+e+'" value="{}"><button type="button" class="btn btn-sm btn-primary reference-button reference_button_filter">Source</button></td>\r\n  <td>\r\n'+generateSelectType(e,t)+"  </td>\r\n  <td>\r\n"+generateSelectFilter(e,t)+"  </td>\r\n</tr>\r\n"}function serializeForm(){let e=null;$(".reference_type").each(function(t){$(this)[0].checked&&(e=$(this).val())});let t=$(".multiple-selection").val(),a=getEntityData(),n=getMapData();return{type:e,entity:a,map:n,yesno:null,truefalse:null,onezero:null,multipleSelection:t}}function deserializeForm(e){$("#modal-create-reference-data").find(".modal-body").empty(),$("#modal-create-reference-data").find(".modal-body").append(getReferenceResource()),selectReferenceType(e),setEntityData(e),setMapData(e)}function addRow(e){let t=e.find("tbody").find("tr:last-child").prop("outerHTML");e.find("tbody").append(t)}function addColumn(e){let t=e.find("thead").find("tr").find("td").length-parseInt(e.attr("data-offset"))-2;e.find("thead").find("tr").find("td:nth("+t+")").after('<td><input class="form-control map-key" type="text" value="" placeholder="Additional attribute name"></td>'),e.find("tbody").find("tr").each(function(e){$(this).find("td:nth("+t+")").after('<td><input class="form-control map-value" type="text" value="" placeholder="Additional attribute value"></td>')}),e.find("tfoot").find("tr").find("td").attr("colspan",e.find("thead").find("tr").find("td").length)}function removeLastColumn(e){let t=e.find("thead").find("tr").find("td").length,a=parseInt(e.attr("data-offset")),n=t-a-2;t>a+3&&(e.find("thead").find("tr").find("td:nth("+n+")").remove(),e.find("tbody").find("tr").each(function(e){$(this).find("td:nth("+n+")").remove()}),e.find("tfoot").find("tr").find("td").attr("colspan",e.find("thead").find("tr").find("td").length))}function selectReferenceType(e){let t=e.type?e.type:"entity",a=$("#modal-create-reference-data .modal-dialog");"entity"==t||"map"==t?(a.addClass("modal-lg"),a.hasClass("modal-md")&&a.removeClass("modal-md")):(a.addClass("modal-md"),a.hasClass("modal-lg")&&a.removeClass("modal-lg")),$('.reference_type[value="'+t+'"]').length>0&&($('.reference_type[value="'+t+'"]')[0].checked=!0),$(".reference-section").css({display:"none"}),"entity"==t?$(".entity-section").css({display:"block"}):"map"==t&&$(".map-section").css({display:"block"})}function setEntityData(e){e.entity=e&&e.entity?e.entity:{};let t=e.entity;t.entityName=t.entityName?t.entityName:"",t.tableName=t.tableName?t.tableName:"",t.primaryKey=t.primaryKey?t.primaryKey:"",t.value=t.value?t.value:"",t.objectName=t.objectName?t.objectName:"",t.propertyName=t.propertyName?t.propertyName:"",t.textNodeFormat=t.textNodeFormat?t.textNodeFormat:"",t.indent=t.indent?t.indent:"";let a='[data-name="entity"]';$(a).find(".rd-entity-name").val(t.entityName),$(a).find(".rd-table-name").val(t.tableName),$(a).find(".rd-primary-key").val(t.primaryKey),$(a).find(".rd-value-column").val(t.value),$(a).find(".rd-reference-object-name").val(t.objectName),$(a).find(".rd-reference-property-name").val(t.propertyName),$(a).find(".rd-option-text-node-format").val(t.textNodeFormat),$(a).find(".rd-option-indent").val(t.indent);let n=e.multipleSelection||"0";"1"!=n&&(n="0"),$(".multiple-selection").val(n),setSpecificationData(e),setSortableData(e),setAdditionalOutputData(e)}function getEntityData(){let e='[data-name="entity"]';return{entityName:$(e).find(".rd-entity-name").val().trim(),tableName:$(e).find(".rd-table-name").val().trim(),primaryKey:$(e).find(".rd-primary-key").val().trim(),value:$(e).find(".rd-value-column").val().trim(),objectName:$(e).find(".rd-reference-object-name").val().trim(),propertyName:$(e).find(".rd-reference-property-name").val().trim(),textNodeFormat:$(e).find(".rd-option-text-node-format").val(),indent:$(e).find(".rd-option-indent").val(),specification:getSpecificationData(),sortable:getSortableData(),additionalOutput:getAdditionalOutputData()}}function setSpecificationData(e){let t=$('[data-name="specification"]'),a=e.entity.specification;if(void 0!==a&&null!=a&&a.length>0)for(let n in a){n>0&&addRow(t);let i=t.find("tr:last-child"),l=a[n];i.find(".rd-column-name").val(l.column),i.find(".rd-value").val(l.value)}}function getSpecificationData(){let e=[];return $('[data-name="specification"]').find("tbody").find("tr").each(function(t){let a=$(this),n=a.find(".rd-column-name").val().trim(),i=a.find(".rd-value").val().trim();n.length>0&&e.push({column:n,value:fixValue(i)})}),e}function setSortableData(e){let t=$('[data-name="sortable"]'),a=e.entity.sortable;if(void 0!==a&&null!=a&&a.length>0)for(let n in a){n>0&&addRow(t);let i=t.find("tr:last-child"),l=a[n];i.find(".rd-column-name").val(l.sortBy),i.find(".rd-order-type").val(l.sortType)}}function getSortableData(){let e=[];return $('[data-name="sortable"]').find("tbody").find("tr").each(function(t){let a=$(this),n=a.find(".rd-column-name").val().trim(),i=a.find(".rd-order-type").val().trim();n.length>0&&e.push({sortBy:n,sortType:i})}),e}function setAdditionalOutputData(e){let t=$('[data-name="additional-output"]'),a=e.entity.additionalOutput;if(void 0!==a&&null!=a&&a.length>0)for(let n in a){n>0&&addRow(t);let i=t.find("tr:last-child"),l=a[n];i.find(".rd-column-name").val(l.column)}}function getAdditionalOutputData(){let e=[];return $('[data-name="additional-output"]').find("tbody").find("tr").each(function(t){let a=$(this).find(".rd-column-name").val().trim();a.length>0&&e.push({column:a})}),e}function setMapData(e){let t='[data-name="map"]',a=$(t),n=[];e.map=e.map?e.map:[];let i=e.map,l=[];if(i.length>0){let o=i[0],r=0;for(let d in o)o.hasOwnProperty(d)&&(++r>4&&addColumn(a),"value"!=d&&"label"!=d&&"default"!=d&&(n.push(d),l[0]=d));for(let c in n){let s=parseInt(c)+1;a.find("thead").find("tr").find(".map-key:nth-child("+s+")").val(n[c])}for(let u in $(t).find("thead").find("tr").find(".map-key").length>0&&$(t).find("thead").find("tr").find(".map-key").each(function(e){n.push($(this).val().trim())}),i){u>0&&addRow(a);let p=a.find("tr:last-child"),m=i[u];for(let f in p.find(".rd-value").val(m.value),p.find(".rd-label").val(m.label),i[u].default&&(p.find(".rd-selected")[0].checked=!0),n){let h=parseInt(f)+1,y=i[u][n[f]];p.find(".map-value:nth-child("+h+")").val(y)}}}}function getMapData(){let e=[],t='[data-name="map"]',a=[];return $(t).find("thead").find("tr").find(".map-key").length>0&&$(t).find("thead").find("tr").find(".map-key").each(function(e){a.push($(this).val().trim())}),$(t).find("tbody").find("tr").each(function(t){let n=$(this),i=n.find(".rd-value").val().trim(),l,o={value:i,label:n.find(".rd-label").val().trim(),default:n.find(".rd-selected")[0].checked};if(a.length>0){let r=0;n.find(".map-value").each(function(e){let t=$(this).val();a[r].length>0&&(o[a[r]]=t),r++})}e.push(o)}),e}function fixValue(e){return"true"==e||"false"!=e&&("null"==e?null:isNumeric(e)?parseNumber(e):e)}function parseNumber(e){return -1!==e.indexOf(".")?parseFloat(e):parseInt(e)}function isNumeric(e){return"string"==typeof e&&!isNaN(e)&&!isNaN(parseFloat(e))}function setLanguage(e){$("select.target-language").each(function(){let t=$(this);for(let a in t.empty(),e)t[0].options[t[0].options.length]=new Option(e[a].name+" - "+e[a].code,e[a].code)})}function getReferenceResource(){return`
<form action="">
