function init(){let e=document.getElementById("queryTranslatorModal"),t=document.getElementById("entityEditorModal"),a=document.querySelectorAll(".cancel-button"),r=document.querySelector(".import-structure"),n=document.querySelector(".open-entity-editor"),i=document.querySelector(".open-structure"),o=document.querySelector(".translate-structure"),l=document.querySelector(".import-from-entity"),c=document.querySelector(".clear"),d=document.querySelector(".original"),s=document.querySelector(".query-generated"),u=document.querySelector('[name="query"]'),y=document.querySelectorAll(".cell-delete a");r.onclick=function(){e.style.display="block",d.focus()},n.onclick=function(){t.style.display="block",resizablePanels.loadPanelWidth(),editor.updateDiagram()},a.forEach(function(e){e.onclick=function(e){e.target.closest(".modal").style.display="none"}}),c.onclick=function(){d.value=""},o.onclick=function(){let t=d.value,a=document.querySelector('meta[name="database-type"]').getAttribute("content"),r=converter.translate(t,a);document.querySelector('[name="query"]').value=r,e.style.display="none"},i.onclick=function(){document.querySelector(".structure-sql").click()},l.onclick=function(){let e=s.value,a=document.querySelector('meta[name="database-type"]').getAttribute("content"),r="";r="mysql"!=a.toLowerCase()&&"mariadb"!=a.toLowerCase()?converter.translate(e,a):e,document.querySelector('[name="query"]').value=r,t.style.display="none"},y.forEach(function(e){e.addEventListener("click",function(e){e.preventDefault();let t=e.target.getAttribute("data-schema"),a=e.target.getAttribute("data-table"),r=e.target.getAttribute("data-primary-key"),n=e.target.getAttribute("data-value"),i="";i=`DELETE FROM ${""!=t?`${t}.${a}`:a} WHERE ${r} = '${n}';\r
