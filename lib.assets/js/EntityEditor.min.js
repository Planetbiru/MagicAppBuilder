...
`}),t+="</select>"}preference(){let e=this;e.showSettingDialog(`
            <table class="two-side-table">
                <tbody>
                    ...
                    <tr>
                        <td>Column Type</td>
                        <td>${e.createDataTypeOption("column_type")}</td>
                    </tr>
                    <tr>
                        <td>Column Length</td>
