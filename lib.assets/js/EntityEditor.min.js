...
`}),l+="</select>"}setDefaultLength(e,t){let l=e.value;void 0!==this.defaultLength[l]&&(document.querySelector(t).value=this.defaultLength[l])}preference(){let e=this;e.showSettingDialog(`
            ...
            `,"Preferences","OK","Cancel",function(t){t&&(e.primaryKeyDataType=document.querySelector('[name="primary_key_type"]').value,e.primaryKeyDataLength=document.querySelector('[name="primary_key_length"]').value,e.defaultDataType=document.querySelector('[name="column_type"]').value,e.defaultDataLength=document.querySelector('[name="column_length"]').value,"function"==typeof e.callbackSaveConfig&&e.callbackSaveConfig({primaryKeyDataType:e.primaryKeyDataType,primaryKeyDataLength:e.primaryKeyDataLength,defaultDataType:e.defaultDataType,defaultDataLength:e.defaultDataLength}))}),document.querySelector('[name="primary_key_type"]').value=e.primaryKeyDataType,document.querySelector('[name="primary_key_length"]').value=e.primaryKeyDataLength,document.querySelector('[name="column_type"]').value=e.defaultDataType,document.querySelector('[name="column_length"]').value=e.defaultDataLength}showSettingDialog(e,t,l,n,i){let a=document.querySelector("#settingModal"),s=a.querySelector(".confirm-ok"),o=a.querySelector(".confirm-cancel");function r(){a.style.display="none",i(!0)}function c(){a.style.display="none",i(!1)}a.querySelector(".modal-header h3").innerHTML=t,a.querySelector(".modal-body").innerHTML=e,s.innerHTML=l,o.innerHTML=n,a.style.display="block",s.removeEventListener("click",r),o.removeEventListener("click",c),s.addEventListener("click",r),o.addEventListener("click",c)}}