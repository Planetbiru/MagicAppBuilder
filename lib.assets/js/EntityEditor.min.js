...
`}),t+="</select>"}setting(){let e=this;e.showSettingDialog(`
            <table>
                <tbody>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input name="primary_key_length" value=""></td>
                    </tr>
                    <tr>
                        <td>Column Type</td>
                    ...
                    <tr>
                        <td>Column Length</td>
                        <td><input name="column_length" value=""></td>
                    </tr>
                </tbody>
            </table>
            `,"Setting","OK","Cancel",function(t){t&&(e.entities.splice(index,1),e.renderEntities(),e.exportToSQL(),"function"==typeof e.callbackSaveEntity&&e.callbackSaveEntity(e.entities))})}showSettingDialog(e,t,l,n,i){let a=document.querySelector("#settingModal"),s=a.querySelector(".confirm-ok"),o=a.querySelector(".confirm-cancel");function r(){a.style.display="none",i(!0)}function c(){a.style.display="none",i(!1)}a.querySelector(".modal-header h3").innerHTML=t,a.querySelector(".modal-body").innerHTML=e,s.innerHTML=l,o.innerHTML=n,a.style.display="block",s.removeEventListener("click",r),o.removeEventListener("click",c),s.addEventListener("click",r),o.addEventListener("click",c)}}