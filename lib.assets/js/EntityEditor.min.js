...
`}),a+="</select>"}setDefaultLength(e,t){let a=e.value;void 0!==this.defaultLength[a]&&(document.querySelector(t).value=this.defaultLength[a])}preference(){let e=this;e.showSettingDialog(`
        ...
        `,n=new Blob([r],{type:"text/html"}),s=URL.createObjectURL(n),o=document.createElement("a");o.href=s,o.download="diagrams.html",o.click(),URL.revokeObjectURL(s)}createHtmlEntity(e){let t=this,a=document.createElement("table"),i=document.createElement("thead"),l=document.createElement("tr");["columnName","type","length","nullable","default","primaryKey","autoIncrement"].forEach(e=>{let a=document.createElement("th");a.textContent=t.camelToTitle(e),l.appendChild(a)}),i.appendChild(l),a.appendChild(i);let r=document.createElement("tbody");return e.columns.forEach(e=>{let a=t.createHtmlColumn(e);r.appendChild(a)}),a.appendChild(r),a}createHtmlColumn(e){let t=document.createElement("tr");return e.primaryKey=1==e.primaryKey||!0===e.primaryKey,["name","type","length","nullable","default","primaryKey","autoIncrement"].forEach(a=>{let i=document.createElement("td");i.textContent="boolean"==typeof e[a]?!0===e[a]?"true":"false":e[a],t.appendChild(i)}),t}camelToTitle(e){return e.replace(/([A-Z])/g," $1").replace(/^./,e=>e.toUpperCase())}}let tabDragger=null;