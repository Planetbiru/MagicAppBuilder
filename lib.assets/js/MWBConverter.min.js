...
`,e.cols.forEach(e=>{let t=v(p.colMap,e);t&&(o+=`                        <link type="object">${t}</link>
`)}),o+=`                      </value>
...
`,e.refCols.forEach(e=>{let n=v(t.colMap,e);n&&(o+=`                        <link type="object">${n}</link>
`)}),o+=`                      </value>
...
`,o+='                      <value type="string" key="algorithm"></value>\n',o+=`                      <value _ptr_="${this._generatePtr()}" type="list" content-type="object" content-struct-name="db.mysql.IndexColumn" key="columns">
`,e.cols.forEach(t=>{let n=v(p.colMap,t);if(n){let l=this._generateUUID();o+=`                        <value type="object" struct-name="db.mysql.IndexColumn" id="${l}">
...
`,o+='                      <value type="int" key="unique">0</value>\n',o+='                      <value type="int" key="commentedOut">0</value>\n',o+='                      <value type="string" key="createDate"></value>\n',o+='                      <value type="dict" key="customData"/>\n',o+='                      <value type="string" key="lastChangeDate"></value>\n',o+='                      <value type="int" key="modelOnly">0</value>\n',o+=`                      <link type="object" struct-name="GrtNamedObject" key="owner">${p.id}</link>
`,o+='                      <value type="string" key="temp_sql"></value>\n',o+=`                      <value type="string" key="oldName"></value>
`,o+="                    </value>\n"}),p.indexes&&Array.isArray(p.indexes)&&p.indexes.forEach(e=>{let t=this._generateUUID();o+=`                    <value type="object" struct-name="db.mysql.Index" id="${t}">
`,o+='                      <value type="string" key="algorithm"></value>\n',o+=`                      <value _ptr_="${this._generatePtr()}" type="list" content-type="object" content-struct-name="db.mysql.IndexColumn" key="columns">
`,e.columns.forEach(e=>{let n=v(p.colMap,e);if(n){let l=this._generateUUID();o+=`                        <value type="object" struct-name="db.mysql.IndexColumn" id="${l}">
`,o+='                          <value type="int" key="columnLength">0</value>\n',o+='                          <value type="string" key="comment"></value>\n',o+='                          <value type="int" key="descend">0</value>\n',o+='                          <value type="string" key="expression"></value>\n',o+='                          <value type="string" key="name"></value>\n',o+=`                          <link type="object" struct-name="GrtObject" key="owner">${t}</link>
`,o+=`                          <link type="object" struct-name="db.Column" key="referencedColumn">${n}</link>
`,o+="                        </value>\n"}}),o+="                      </value>\n",o+='                      <value type="string" key="indexKind"></value>\n',o+='                      <value type="int" key="keyBlockSize">0</value>\n',o+='                      <value type="string" key="lockOption"></value>\n',o+='                      <value type="int" key="visible">1</value>\n',o+='                      <value type="string" key="withParser"></value>\n',o+='                      <value type="string" key="comment"></value>\n',o+='                      <value type="int" key="deferability">0</value>\n',o+=`                      <value type="string" key="indexType">${e.type||"INDEX"}</value>
`,o+='                      <value type="int" key="isPrimary">0</value>\n',o+=`                      <value type="string" key="name">${e.name}</value>
`,o+=`                      <value type="int" key="unique">${e.unique?1:0}</value>
`,o+='                      <value type="int" key="commentedOut">0</value>\n',o+='                      <value type="string" key="createDate"></value>\n',o+='                      <value type="dict" key="customData"/>\n',o+='                      <value type="string" key="lastChangeDate"></value>\n',o+='                      <value type="int" key="modelOnly">0</value>\n',o+=`                      <link type="object" struct-name="GrtNamedObject" key="owner">${p.id}</link>
`,o+='                      <value type="string" key="temp_sql"></value>\n',o+=`                      <value type="string" key="oldName"></value>
...
`;let $={};for(let j of b.entities)$[j]=this._generateUUID();y.forEach(e=>{let t=$[e.ownerName],n=$[e.referencedName];t&&n&&(o+=`              <value type="object" struct-name="workbench.physical.Connection" id="${this._generateUUID()}">
...
`;let E=40,N=40;for(let w of b.entities){let C=s[w];if(!C)continue;let D=$[w],I=80+20*C.columns.length;o+=`              <value type="object" struct-name="workbench.physical.TableFigure" id="${D}">
...
`,o+=`                <value type="real" key="left">${E}</value>
...
`,b.entities)){let T=$[q];T&&(o+=`                <link type="object">${T}</link>
