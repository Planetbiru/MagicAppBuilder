...
${u.join(",\r\n")}\r
;\r
`}l+="\r\n"}}let b=new Blob([l],{type:"text/sql"}),h=URL.createObjectURL(b),p=document.createElement("a");p.href=h,p.download=`${t}.sql`,document.body.appendChild(p),p.click(),document.body.removeChild(p),URL.revokeObjectURL(h)}function createDatabaseResource(e){return`
    <div id="sqlite-app-container">
      ...
      <main id="sqlite-table-main" class="sqlite-main">
        <div class="sqlite-input-area sqlite-header-section">
          ...
          <span class="sql-file-source btn btn-secondary" data-path="${encodeURIComponent(e)}"><span class="sqlite-file-path"></span></span>
        </div>
