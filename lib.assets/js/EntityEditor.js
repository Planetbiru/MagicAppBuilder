...
class EntityEditor {
     ...
     */
    exportToGraphQL(filename = "schema.graphql", removeIdFields = true) {
        const sqlToGraphQL = {
            CHAR: "String", 
            VARCHAR: "String", 
            TEXT: "String", 
        ...
        let schema = `# GraphQL Schema generated by MagicAppBuilder\n\n`;
        ...
        this.entities.forEach(entity => {
            ...
            entity.columns.forEach(col => {
                ...
                if (col.name.endsWith("_id")) {
                    ...
                    // Only add relation if target exists and is not self
                ...
                // Add scalar field only if not removed by option
