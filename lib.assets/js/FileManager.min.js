let selectedItem=null,contentModified=!0,currentMode=null;function initFileManager(){document.getElementById("dir-tree").addEventListener("click",function(e){if(e.target){if(e.target.classList.contains("dir")){let t=e.target.dataset.dir,n=e.target.closest("li"),i=n.querySelector("ul");i?n.setAttribute("data-open","true"===n.getAttribute("data-open")?"false":"true"):(i=document.createElement("ul"),n.appendChild(i),loadDirContent(t,i,n),n.setAttribute("data-open","true"))}else if(e.target.classList.contains("file")){let a=e.target;openFile(a.dataset.file,a.dataset.extension)}}}),document.querySelector(".btn-save-file").addEventListener("click",function(e){let t;saveFile(document.querySelector(".file-path").value,fileManagerEditor.getValue())}),document.querySelector(".btn-open-file").addEventListener("click",function(e){let t=document.querySelector(".file-path").value,n=getFileExtension(t);openTextFile(t,n)});let e=document.getElementById("dir-tree"),t=document.getElementById("context-menu");e.addEventListener("contextmenu",function(e){e.preventDefault();let n=e.target.closest("li");if(n&&n.dataset&&n.dataset.type){selectedItem=e.target;let i="",a=n.dataset.type;"file"===a?i=n.querySelector("span").dataset.file:"dir"===a&&(i=n.querySelector("span").dataset.dir);let l=e.pageX,r=e.pageY;t.className="context-menu";let o=t.querySelector("ul");o.innerHTML="","file"===a?(o.innerHTML=`
              ...
              `,r+t.offsetHeight>window.innerHeight&&(r=window.innerHeight-t.offsetHeight-10),t.style.left=`${l}px`,t.style.top=`${r}px`,t.style.display="block"):"dir"===a?(o.innerHTML=`
