...
`,m=!0}}if(!(t&&m)){let C;C=o.primaryKey?"ID":a[o.type.toUpperCase()]||"String",p&&(C+="!"),i+=`    ${n(o.name)}: ${C}
`}}),i+=`}
`}),e.forEach(t=>{i+=`
...
`,i+=`
type Mutation {
`,e.forEach(e=>{let t=r(e.name),a=`${t}Input`,l=e.columns.filter(e=>e.primaryKey);if(i+=`    create${t}(input: ${a}!): ${t}
