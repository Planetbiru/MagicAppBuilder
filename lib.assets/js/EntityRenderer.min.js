...
`),t.modificationDate&&(i+=`**Last modified on:** ${e.formatDate(t.modificationDate)}
`),t.modifier&&""!==t.modifier&&"{{userName}}"!==t.modifier&&(i+=`**Last modified by:** ${t.modifier}
`),i+=`
