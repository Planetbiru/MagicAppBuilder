...
$currentModule = new PicoModule($appConfig, $database, $appModule, "/", "module", "Module");
...
{
$appEntityLanguage = new AppEntityLanguage(new Module(), $appConfig, $currentUser->getLanguageId());
