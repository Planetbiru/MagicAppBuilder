...
To simplify the process of creating database modules, the Entity Editor now **automatically assigns a dependency depth to each entity**, allowing developers to **generate or scaffold modules in the correct order**.
