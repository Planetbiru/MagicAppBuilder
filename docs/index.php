...
class PhpDocumentCreator // NOSONAR
{
     ...
     * Initializes the Parsedown object to be used within the class.
     */
    ...
    public function renderDirectoryStructure($structure, $baseDir) {
        ...
        foreach ($structure as $item) {
            if ($item->type == "file") {
                ...
                $relativePath = "#AppBuilder-" . str_replace(["\\", "/", ".php"], ["-", "-", ""], $this->getRelativePath($item->pathname, $baseDir));
...
<head>
    ...
    <title>AppBuilder Documentation</title>
...
$srcDir = dirname(__DIR__) . '/inc.lib/classes/AppBuilder';
