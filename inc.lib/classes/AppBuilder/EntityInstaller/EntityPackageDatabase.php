...
/**
 * The EntityPackageDatabase class represents an entity in the "package_database" table.
 *
 * This entity maps to the "package_database" table in the database and supports ORM (Object-Relational Mapping) operations. 
 ...
 */
class EntityPackageDatabase extends MagicObject
{
	/**
	 * Package Database ID
	 * 
