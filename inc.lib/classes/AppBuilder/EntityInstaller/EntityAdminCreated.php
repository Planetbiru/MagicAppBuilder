...
/**
 * The EntityAdminCreated class represents an entity in the "admin_created" table.
 *
 * This entity maps to the "admin_created" table in the database and supports ORM (Object-Relational Mapping) operations. 
 ...
 * @Table(name="admin_created")
 */
class EntityAdminCreated extends MagicObject
{
	/**
	 * Period
	 * 
