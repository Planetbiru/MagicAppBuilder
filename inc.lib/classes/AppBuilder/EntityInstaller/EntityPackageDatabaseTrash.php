...
/**
 * The EntityPackageDatabaseTrash class represents an entity in the "package_database_trash" table.
 *
 * This entity maps to the "package_database_trash" table in the database and supports ORM (Object-Relational Mapping) operations. 
 ...
 * @Table(name="package_database_trash")
 */
class EntityPackageDatabaseTrash extends MagicObject
{
	/**
	 * Package Database Trash ID
	 * 
	 * @Id
	 * @GeneratedValue(strategy=GenerationType.TIMEBASED)
	 * @NotNull
	 * @Column(name="package_database_trash_id", type="varchar(40)", length=40, nullable=false)
	 * @DefaultColumn(value="NULL")
	 * @Label(content="Package Database Trash ID")
	 * @MaxLength(value=40)
	 * @var string
	 */
	protected $packageDatabaseTrashId;
