...
/**
 * The EntityPackageThemeTrash class represents an entity in the "package_theme_trash" table.
 *
 * This entity maps to the "package_theme_trash" table in the database and supports ORM (Object-Relational Mapping) operations. 
 ...
 * @Table(name="package_theme_trash")
 */
class EntityPackageThemeTrash extends MagicObject
{
	/**
	 * Package Theme Trash ID
	 * 
	 * @Id
	 * @GeneratedValue(strategy=GenerationType.UUID)
	 * @NotNull
	 * @Column(name="package_theme_trash_id", type="varchar(40)", length=40, nullable=false)
	 * @DefaultColumn(value="NULL")
	 * @Label(content="Package Theme Trash ID")
	 * @MaxLength(value=40)
	 * @var string
	 */
	protected $packageThemeTrashId;
