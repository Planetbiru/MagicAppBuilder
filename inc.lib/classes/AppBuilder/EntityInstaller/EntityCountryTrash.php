...
/**
 * The EntityCountryTrash class represents an entity in the "country_trash" table.
 *
 * This entity maps to the "country_trash" table in the database and supports ORM (Object-Relational Mapping) operations. 
 ...
 * @Table(name="country_trash")
 */
class EntityCountryTrash extends MagicObject
{
	/**
	 * Country Trash ID
	 * 
	 ...
	 * @Label(content="Country Trash ID")
	 * @MaxLength(value=40)
	 * @var string
	 */
	protected $countryTrashId;
