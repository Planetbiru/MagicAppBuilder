...
/**
 * The EntityLicense class represents an entity in the "license" table.
 *
 * This entity maps to the "license" table in the database and supports ORM (Object-Relational Mapping) operations. 
 ...
 * @Table(name="license")
 */
class EntityLicense extends MagicObject
{
	/**
	 * License ID
	 * 
	 ...
	 * 
	 * @Column(name="allow_commercial_use", type="tinyint(1)", length=1, defaultValue="1", nullable=true)
	 ...
	 * Allow Modification
	 * 
	 * @Column(name="allow_modification", type="tinyint(1)", length=1, defaultValue="1", nullable=true)
	 * @DefaultColumn(value="1")
