...
/**
 * The EntityPackageCodeTrash class represents an entity in the "package_code_trash" table.
 *
 * This entity maps to the "package_code_trash" table in the database and supports ORM (Object-Relational Mapping) operations. 
 ...
 * @Table(name="package_code_trash")
 */
class EntityPackageCodeTrash extends MagicObject
{
	/**
	 * Package Code Trash ID
	 * 
	 * @Id
	 * @GeneratedValue(strategy=GenerationType.TIMEBASED)
	 * @NotNull
	 * @Column(name="package_code_trash_id", type="varchar(40)", length=40, nullable=false)
	 * @DefaultColumn(value="NULL")
	 * @Label(content="Package Code Trash ID")
	 * @MaxLength(value=40)
	 * @var string
	 */
	protected $packageCodeTrashId;
