...
$profileName = 'numberFormat';

$inputPost = new InputPost();

if($inputPost->getDecimal() !== null)
{
    $profile = new stdClass;
    $profile->decimal = $inputPost->getDecimal();
    $profile->separator = $inputPost->getSeparator();
    $profile->thousandsSeparator = $inputPost->getThousandsSeparator();
