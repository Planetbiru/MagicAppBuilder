...
use MagicApp\AppDto\MocroServices\OutputFieldApproval;
use MagicApp\AppDto\MocroServices\ResponseBody;
use MagicApp\AppDto\MocroServices\UserFormOutputApproval;
...
$data->addOutput(
    new OutputFieldApproval(
        new InputField("userId", "User ID"), 
        "string", 
        new InputFieldValue(1, "Wowo"), 
        new InputFieldValue(1, "Sisi")
    )
);
$data->addOutput(
    new OutputFieldApproval(
        new InputField("admin", "Admin"), 
        "string", 
        new InputFieldValue(2, "Didi"), 
        new InputFieldValue(3, "Dede")
    )
);
