...
<thead>
<tr>
${e.map(t=>{let e=this.state.orderBy.field===t;return e&&this.state.orderBy.direction,`<th class="sortable" data-sort-key="${t}" data-sort-direction="${e?"ASC"===this.state.orderBy.direction?"asc":"desc":""}">
...
`;try{let n=await this.gqlQuery(a,{id:t});this.showPageWrapper();let s=n[this.currentEntity.name],l=`<div class="back-controls">
