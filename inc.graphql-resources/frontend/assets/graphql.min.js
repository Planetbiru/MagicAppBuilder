...
`;try{this.dom.tableDataContainer.innerHTML=this.t("loading"),this.dom.paginationContainer.innerHTML="";let s=await this.gqlQuery(n,{limit:this.state.limit,offset:e,orderBy:a,filter:i}),l=s[this.currentEntity.pluralName];l&&l.items&&l.items.length>0?this.renderTable(l.items):this.dom.tableDataContainer.innerHTML='<p style="color: red;">Data not found</p>',this.renderPagination(l),l.errors&&l.errors.length>0&&console.error(l.errors)}catch(r){this.dom.tableDataContainer.innerHTML=`<p style="color: red;">${r.message}</p>`}}renderTable(t){let e=Object.keys(this.currentEntity.columns),i=`
