...
`;try{let n=await this.gqlQuery(a,{id:t}),s=n.data;this.showPageWrapper();let l=this.currentEntity.detailColumns||[],r=s[this.currentEntity.name];if(!r&&n.errors&&n.errors.length>0){let o=`<div class="back-controls">
...
<table class="table">
<tbody>`;for(let h in this.currentEntity.columns){if(!l.includes(h))continue;let c=this.currentEntity.columns[h],u=c.references;if(d+=`<tr>
