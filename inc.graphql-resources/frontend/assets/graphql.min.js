...
<thead>
<tr>
${e.map(t=>{let e=this.state.orderBy.field===t;return`<th class="sortable" data-sort-key="${t}" data-sort-direction="${e?"ASC"===this.state.orderBy.direction?"asc":"desc":""}">
